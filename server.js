...
//:                                                          :// // [102]
//: SOURCE__CODE : github.com/KanjiCoder/AIM_129             :// // [129][128][127][126][125][124][122][121][120][119][117][116][115][113][112][111][110][109][108][107][106][105][104][103][102][100][099][098][097][096][095][094][093][092][091][090][089][088][087][086][085][084][083][082][081][080][079]                               
...
//|--|--|--|--|--|--|--|--|--|SUBS|--|--|--|--|--|--|--|--|--|// // [125]
    ...
    PRIVATE_F_SEXYCAM_PAD_NUM(                                   // [126]
        ...
        if( i_pad_num >= 1 && i_pad_num <= 9 ){                  // [127]
            ...
            //:---------:#_SEXYCAM_SETS_ZEROBASIS_#:[129]://     // [129]
                                                                 // [129]
            console.log( "[We might be done not sure]" );        // [129]
                                                                 // [127]
        };;                                                      // [127]
                                                                 // [---]
    };;                                                          // [126]
...
/** ******************************************************** ***
          ...
          :---------------------------------------------------:  // [129]
    [129] : 1 : Detect Times In Row For Numpad Press          :  // [129]
          : 2 : Get Correct ZeroBasis                         :  // [129]
          : 3 : Focus Camera Into Center Of Levelpack         :  // [129]
          : . : with ZERO zoom , but create punchy            :  // [129]
          : . : zoom-effect by cycling to more coarse         :  // [129]
          : . : zero basis enums with each successive         :  // [129]
          : . : press of the same number key.                 :  // [129]
          : 4 : d_sexycam_not_zeb lookup table to help        :  // [129]
          : . : with item #3 in this list.                    :  // [129]
          :---------------------------------------------------:  // [129]
