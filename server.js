...
//|--|--|--|--|--|--|--|--|--|SUBS|--|--|--|--|--|--|--|--|--|// // [156]
    ...
    ,   i_v16  //:Tile_VALUE[ #_0_TO_15_ALL_LAYERS_#    ]://     // [170]
        ...
        //:::::::::( 0xAARRGGBB )::::::::::::::::::::::::://     // [170]
                                                                 // [---]
        //:!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!://     // [171]
        //: RETROACTIVELY_REMOVED... Hackish rebase...   ://     // [171]
        //: Will put body of[ LA3_V16_U32 ]here in       ://     // [171]
        //: video #1_7_2#... It deserves its own video   ://     // [171]
        //: and we found TOO MANY BUGS in video #1_7_1#  ://     // [171]
        //: that we need to go over.                     ://     // [171]
        //:!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!://     // [171]
                                                                 // [---]
        return( o_u32 );                                         // [170]
    };;                                                          // [170]
