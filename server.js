    ...
    //: u_dup =( DiscreteUnitSelection )/( NumPixelsOnScreen ); // [097]
        ...
        //:use_the_sample_point:[099]:-----------------------://// [099]
            ...
            //: @u_t64@/@t64@ : Tile  Coord X&Y [0-63]    ://   // [099]
                                                                // [099]
            UV2 u_h03 =( u_dsc / c_duh );                       // [099]
            UV2 u_r05 =( u_dsc / c_dur );                       // [099]
            UV2 u_t64 =( u_dsc / c_dut );                       // [099]
                                                                // [099]
                ...
                u_t64 =  u_t64-((u_t64 / u64)* u64 );//:MOD64://// [099]
                                                                // [099]
                                                                // [099]
            U32 h09_lum = u_h03-((u_h03/u_2)*u_2);  //:@MOD2@://// [099]
            U32 r25_lum = u_r05-((u_r05/u_2)*u_2);  //:@MOD2@://// [099]
            U32 t64_lum = u_t64-((u_t64/u_2)*u_2);  //:@MOD2@://// [099]
                                                                // [099]
            out_f_c =FV4(                                       // [099]
                                                                // [099]
