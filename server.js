...
//:                                                          :// // [102]
//: SOURCE__CODE : github.com/KanjiCoder/AIM_134             :// // [134][133][132][131][130][129][128][127][126][125][124][122][121][120][119][117][116][115][113][112][111][110][109][108][107][106][105][104][103][102][100][099][098][097][096][095][094][093][092][091][090][089][088][087][086][085][084][083][082][081][080][079]                               
    ...
    PRIVATE_F_CAMERAH_VP1(                                       // [109]
        ...
        {                                                        //      [122]  
            ...
            {                                                    // [134]
                ...
                //:::::::::::::::::::::::::::::::::::::::://     // [134]
                                                                 // [134]
                let cam_max =Math.floor( c_dut / 2 )-1;          // [134]
                                                                 // [134]
                if( c_w_lef > cam_max ){ ERR("[c_w_lef]");};     // [134]
                if( c_w_rig > cam_max ){ ERR("[c_w_lef]");};     // [134]
                if( c_w_top > cam_max ){ ERR("[c_w_lef]");};     // [134]
                if( c_w_bot > cam_max ){ ERR("[c_w_lef]");};     // [134]
            }                                                    // [134]
            //:-------------:#_BOUNDCHECK_CAMWALL_#:[134]://     // [134]
        }                                                        //      [122]
        //:------------------:#_NOPAN_CAMWALL_MAG_#:[121]://     //      [121]
