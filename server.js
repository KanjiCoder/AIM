    ...
    ,   i_pay //: INPUT.Pan.Y ://                                // [113]
        ...
        //:Translate_Camera_Org:[113]:-------------------://     // [113]
            ...
            {                                                    // [122]
                                                                 // [122]
                //######################################//       // [122]
                //# THIS CODE IS NOT QUITE CORRECT AND #//       // [122]
                //# IT IS IN THE WRONG AREA/FUNCTION   #//       // [122]
                //######################################//       // [122]
                                                                 // [122]
                let c_w = d_camwall ;                            // [122]
                                                                 // [122]
                c_w[ x_0 ]=( 0 );                                // [122][121]
                c_w[ x_1 ]=( 0 );                                // [122][121]
                c_w[ y_0 ]=( 0 );                                // [122][121]
                ...
                //: @ASS_NNI@ : Assert Non-Negative-Int ://      // [122]
                                                                 // [122]
                if( n_x < b_0 ){ c_w[x_0]=ASS_NNI(b_0-n_x);};    // [122][121]
                if( n_x > b_1 ){ c_w[x_1]=ASS_NNI(n_x-b_1);};    // [122][121]
                                                                 // [122]
                if( n_y < b_0 ){ c_w[y_0]=ASS_NNI(b_0-n_y);};    // [122][121]
                if( n_y > b_1 ){ c_w[y_1]=ASS_NNI(n_y-b_1);};    // [122][121]
                                                                 // [122]
            }                                                    // [122]
            //:--------------:#_NOPAN_CAMWALL_MAG_#:[121]://     // [121]
                                                                 // [---]
