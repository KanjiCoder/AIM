...
if( /** __KONAMIC__ **/ notnode ){ //:::::BEG[ KONAMIC_DATA ]:// // [180]
                                                                 // [---]
    var d_konamic_h3x_h3y_tog =( 0 );  //:#_KON_TOG_#://         // [202]
                                                                 // [---]
...
//|--|--|--|--|--|--|--|--|--|SUBS|--|--|--|--|--|--|--|--|--|// // [---][???]
    ...
    PRIVATE_F_KEYMAST_EVT_N10(                                   // [203]
        ...
        &&  i_evt_key.keyCode <= 105  //:numpad9://              // [203][MOV][105][---]
            ...
            pad_num=( k_c - 96 );                                // [203][MOV][131][105]
            LOG( "[EVT_N10:NUMPAD_KEYCODE]:" , k_c     );        // [203][MAE][131][---]
            LOG( "[EVT_N10:NUMPAD_PAD_NUM]:" , pad_num );        // [203][MAE][131][---]
        };;                                                      // [203][MOV][105][---]
                                                                 // [-------------][---]
        return( o_n10 );                                         // [203][--------][---]
                                                                 // [203]
