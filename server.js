...
//:TOP_LEVEL_LOOKUP_TABLES:[128]:============================://
    ...
    {                                                            // [162]
        ...
        let _v_ = ( 1 ); //: void is here ://                    // [162]
                                                                 // [162]
        var d_g25_vod =new Uint32Array([                         // [162]
                                                                 // [162]
    ...
    #define inn_u_gty "[USE:u32_gty::::::::]"                    //      [175]
        ...
        //:#_Simple_Yes_No_For_Now_#:[178]:--------------://     // [178]
            ...
            FV4 strobecolor =((u_0 != ( d_tik & u_1 ))           // [178]
                                                                 // [178]
                ? ( FV4( 0.5,0.5,0.5,1.0 ) ) //: YES ://         // [178]
                : ( FV4( 1.0,1.0,1.0,1.0 ) ) //: _NO ://         // [178]
            );;                                                  // [178]
        ...
        //:use_the_sample_point:[099]:-----------------------:// // [099]
            ...
            #define G GET_LA3_FV4    //:[GET_GEO_BOM_FAD]://     //      [178]
                ...
                //:#_COMPOSITE_GBF_LAYERS_#:[179]:-------://     // [179]
                                                                 // [179]
                    //:::::::::::::::::::::::::::::::::::://     // [179]
                    //: Not actual alpha compositing,    ://     // [179]
                    //: we are getting too far ahead.    ://     // [179]
                    //: we want to be able to see        ://     // [179]
                    //: ANYTHING, ANY FEEDBACK AT ALL.   ://     // [179]
                    //: Then we can polish with alpha    ://     // [179]
                    //: compositing in #1_8_1 probably.  ://     // [179]
                    //:::::::::::::::::::::::::::::::::::://     // [179]
                    if( f_0 != f_geo.a                           // [179]
                    ||  f_0 != f_bom.a                           // [179]
                    ||  f_0 != f_fad.a                           // [179]
                    ){                                           // [179]
                        out_f_c=FV4( f_1 , f_1 , f_1 , f_1 );    // [179]
                    };;                                          // [179]
                                                                 // [179]
                //:-------:#_COMPOSITE_GBF_LAYERS_#:[179]://     // [179]
                                                                 // [---]
...
if( /** __PIX2048__ **/ notnode ){                               //      [156]
    ...
    var d_pix0512 = new Uint8Array( 4 *  512 *  512 );           //      [156]
                                                                 //      [---]
    var d_pix2048_dir =( 0 /** Is pix2048 dirty? **/ );          // [183][---]
                                                                 //      [---]
};;                                                              // [---][156]
                                                                 // [---]
...
if( /** __KONAMIC__ **/ notnode ){ //:::::BEG[ KONAMIC_DATA ]:// // [180]
    ...
    var d_konamic_ptr =( 0 ); //:Rests On The Index It Is://     // [181]
                              //:Intending To Use Next.  ://     // [181]
                                                                 // [181]
...
//|--|--|--|--|--|--|--|--|--|SUBS|--|--|--|--|--|--|--|--|--|// // [156]
    ...
    const   F_PIX2048_TEXPUSH    =( "[FIX:F_ARTGIRL.TEX_PUT]" ); // [184]
    const   F_PIX2048_TEXPUSH_ALL=( "[FIX:F_ARTGIRL.TEX_PUT]" ); // [184]
    const   F_PIX2048_TEX_PUT    =( "[FIX:F_ARTGIRL.TEX_PUT]" ); // [184]
    const   F_PIX2048_TEX_PUT_ALL=( "[FIX:F_ARTGIRL.TEX_PUT]" ); // [184]
                                                                 // [184]
    const   F_PIX2048_TIK = function                             // [184]
    PRIVATE_F_PIX2048_TIK(                                       // [184]
                                                                 // [184]
        /** VOID **/                                             // [184]
    ){                                                           // [184]
        ERR( "[#_LET_ARTGIRL_HANDLE_DIRTY_PIX_#]" );             // [184]
                                                                 // [184]
        //- if( d_pix2048_dir >= 1 ){                    -//     // [184]
        //-     d_pix2048_dir =( 0 );;                   -//     // [184]
        //-                                              -//     // [184]
    ...
    const   F_PIX2048_MEM_SET = "[FIX:H3X_H3Y_U32]" ;            // [183]
    const   F_PIX2048_MEMSET  = "[FIX:H3X_H3Y_U32]" ;            // [183]
    const   F_PIX2048_MEM_PUT = "[FIX:H3X_H3Y_U32]" ;            // [183]
    const   F_PIX2048_MEMPUT  = "[FIX:H3X_H3Y_U32]" ;            // [183]
                                                                 // [183]
    const   F_PIX2048_H3X_H3Y_U32 = function                     // [183]
    PRIVATE_F_PIX2048_H3X_H3Y_U32(                               // [183]
                                                                 // [183]
        i_h3x //: [ hotel cell [ 0|1|2 ] Axis - X ] ://          // [183]
    ,   i_h3y //: [ hotel cell [ 0|1|2 ] Axis - Y ] ://          // [183]
    ,   i_u32 //: [ U32 Fill Value For Each Pixel ] ://          // [183]
    ){                                                           // [183]
        if( d_eci >= 1 ){                                        // [183]
            //:::::::( 0x12345678 )::::::::::::::::::::::://     // [183]
            let _m_ =( 0xFFFFFFFF );                             // [183]
            //:::::::( 0xRRGGBBAA )::::::::::::::::::::::://     // [183]
            ASS( i_h3x >= 0 && i_h3x <=(3-1) , "[IH3X]" );       // [183]
            ASS( i_h3y >= 0 && i_h3y <=(3-1) , "[IH3Y]" );       // [183]
            ASS( i_u32 >= 0 && i_u32 <=(_m_) , "[IU32]" );       // [183]
        };;                                                      // [183]
                                                                 // [183]
        var u08_red //:@u08_red@ : BYTE_OF : RED   ::::::://     // [183]
        ,   u08_gre //:@u08_gre@ : BYTE_OF : GREEN ::::::://     // [183]
        ,   u08_blu //:@u08_blu@ : BYTE_OF : BLUE  ::::::://     // [183]
        ,   u08_alp //:@u08_alp@ : BYTE_OF : ALPHA ::::::://     // [183]
        ;;;;;;;;;;;                                              // [183]
        var x00 , x01 , y00 , y01 ; //: Pixel Selection :://     // [183]
        var p_x , p_y , p_i , p_c ; //: Pixel Location  :://     // [183]
        let A_B =( ASSBYTE );       //: Assert_Is_Byte  :://     // [183]
                                                                 // [183]
        u08_red = ( i_u32 >>> 24 )&( 0xFF ); A_B( u08_red );     // [183]
        u08_gre = ( i_u32 >>> 16 )&( 0xFF ); A_B( u08_gre );     // [183]
        u08_blu = ( i_u32 >>>  8 )&( 0xFF ); A_B( u08_blu );     // [183]
        u08_alp = ( i_u32 >>>  0 )&( 0xFF ); A_B( u08_alp );     // [183]
                                                                 // [183]
        x00 = ( i_h3x * 512 )+(       0 );                       // [183]
        x01 = ( i_h3x * 512 )+( 512 - 1 );                       // [183]
                                                                 // [183]
        y00 = ( i_h3y * 512 )+(       0 );                       // [183]
        y01 = ( i_h3y * 512 )+( 512 - 1 );                       // [183]
                                                                 // [183]
        for(p_y = y00 ; p_y <= y01 ; p_y++ ){                    // [183]
        for(p_x = x00 ; p_x <= x01 ; p_x++ ){                    // [183]
                                                                 // [183]
            p_i =( p_x + ( p_y * 2048 ) );  //: PIX_DEX :://     // [183]
            p_c =( p_i * 4 );               //: PIX_COM :://     // [183]
                                                                 // [183]
            d_pix2048[ p_c + 0 ] =( u08_red );                   // [183]
            d_pix2048[ p_c + 1 ] =( u08_gre );                   // [183]
            d_pix2048[ p_c + 2 ] =( u08_blu );                   // [183]
            d_pix2048[ p_c + 3 ] =( u08_alp );                   // [183]
        };;};;                                                   // [183]
                                                                 // [183]
        d_pix2048_dir=( 1 );                                     // [183]
    };;                                                          // [183]
...
//|--|--|--|--|--|--|--|--|--|SUBS|--|--|--|--|--|--|--|--|--|// // [156]
    ...
    const   F_TILEBOI_LA3_V16_U32 = function                     // [170]
    PRIVATE_F_TILEBOI_LA3_V16_U32(                               // [170]
                                                                 // [170]
        i_la3  //:Data Layer[ 0==TILES,1==BOMBS,2==FADA ]://     // [170]
    ,   i_v16  //:Tile_VALUE[ #_0_TO_15_ALL_LAYERS_#    ]://     // [170]
    ){                                                           // [170]
        var o_u32 =( 0x00000000 );  //: Output_Tile_Data ://     // [170]
        //:::::::::( 0xAARRGGBB )::::::::::::::::::::::::://     // [170]
                                                                 // [---]
        if( d_eci >= 1 ){                                        // [172]
            ASS( i_la3 >= 0 && i_la3 <=( 3-1) , "[I_LA3]" );     // [172]
            ASS( i_v16 >= 0 && i_v16 <=(16-1) , "[I_V16]" );     // [172]
        };;                                                      // [172]
                                                                 // [172]
        if( c_lay_til === i_la3 ){                               // [172]
                                                                 // [172]
            let e_t_i =( 0x00 /**@e_t_i@**/ );                   // [172]
            ASS(e_t_i < 0xF0000000 , "[@E_T_I_TMD@]" );          // [172]
            //:_________0xAARRGGBB__________________://          // [172]
                                                                 // [172]
            o_u32 =(( 0x00                                       // [172]
            |      (  ( i_v16 & 0x0000000F ) << (  28) )         // [172]
            |      (  ( e_t_i & 0x0FFFFFFF ) << (   0) )         // [172]
            )>>>0 );; //::::::::0x12345678:::::::::::://         // [172]
        }else                                                    // [172]
        if( c_lay_bom === i_la3 ){                               // [172]
                                                                 // [172]
            let e_b_i =( 0x00 /**@e_b_i@**/ );                   // [172]
            ASS(e_b_i < 0xF0000000 , "[@E_B_I_TMD@]" );          // [172]
            //:_________0xAARRGGBB__________________://          // [172]
                                                                 // [172]
            o_u32 =(( 0x00                                       // [172]
            |      (  ( i_v16 & 0x0000000F ) << (  28) )         // [172]
            |      (  ( e_b_i & 0x0FFFFFFF ) << (   0) )         // [172]
            )>>>0 );; //::::::::0x12345678:::::::::::://         // [172]
        }else                                                    // [172]
        if( c_lay_fad === i_la3 ){                               // [172]
                                                                 // [172]
            let e_f_i =( d_tik /**@e_f_i@**/ );                  // [172]
            ASS(e_f_i < 0xF0000000 , "[@E_F_I_TMD@]" );          // [172]
            //:_________0xAARRGGBB__________________://          // [172]
                                                                 // [172]
            o_u32 =(( 0x00                                       // [172]
            |      (  ( i_v16 & 0x0000000F ) << (  28) )         // [172]
            |      (  ( e_f_i & 0x0FFFFFFF ) << (   0) )         // [172]
            )>>>0 );; //::::::::0x12345678:::::::::::://         // [172]
                                                                 // [172]
            if( d_bug >= 1 ){                                    // [172]
                                                                 // [172]
                ASS( o_u32 >= 0 , "[VAL_GT0]" );                 // [172]
                //::::::::::::::::::::::::::::0x12345678:://     // [172]
                let v16 =(( o_u32 >>> (28) )&(0x0000000F));      // [172]
                let tik =(( o_u32 >>> ( 0) )&(0x0FFFFFFF));      // [172]
                //::::::::::::::::::::::::::::0xRRGGBBAA:://     // [172]
                if( tik!=d_tik ){                                // [172]
                    YEL("[TICKINFUCKED2022]");                   // [172]
                    ERR("[TICKINFUCKED2022]");                   // [172]
                };;                                              // [172]
                if( v16!=i_v16 ){                                // [172]
                    YEL("[V16_CHECK_FAIL_2022]");                // [172]
                    ERR("[V16_CHECK_FAIL_2022]");                // [172]
                };;                                              // [172]
            };;                                                  // [172]
        }else{                                                   // [172]
            ERR("[NOT:til_bom_fad:2022]");                       // [172]
        };;                                                      // [172]
                                                                 // [---]
        return( o_u32 );                                         // [170]
    };;                                                          // [170]
    ...
    ,   F_TILEBOI_EDI_GET     = "[FTB_ES_PG_U32]"   ////////     // [161]
                                                                 // [---]
    ,   F_TILEBOI_PUT_TIL_U32 = "[FTB_ES_PG_U32]"   ////////     // [170]
    ,   F_TILEBOI_GET_TIL_U32 = "[FTB_ES_PG_U32]"   ////////     // [170]
    ,   F_TILEBOI_TIL_PUT_U32 = "[FTB_ES_PG_U32]"   ////////     // [170]
    ,   F_TILEBOI_TIL_GET_U32 = "[FTB_ES_PG_U32]"   ////////     // [170]
                                                    ////////     // [170]
    ,   F_TILEBOI_PUT_TIL     = "[FTB_ES_PG_U32]"   ////////     // [170]
    ,   F_TILEBOI_GET_TIL     = "[FTB_ES_PG_U32]"   ////////     // [170]
    ,   F_TILEBOI_TIL_PUT     = "[FTB_ES_PG_U32]"   ////////     // [170]
    ,   F_TILEBOI_TIL_GET     = "[FTB_ES_PG_U32]"   ////////     // [170]
                                                                 // [---]
                                                    ////////     // [161]
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;     // [161]
                                                                 // [161]
                                                                 // [---]
    //:Calc_Data_Pixel_Component:[162]:------------------://     //      [162]
                                                                 //      [162]
    const   F_TILEBOI_HI9_TE7_LA3_TLX_TLY_DPI = "[WRONG]" ;;     //      [162]
    const   F_TILEBOI_HI9_TE7_LA3_TLX_TLY_COM = "[WRONG]" ;;     //      [162]
                                                                 //      [162]
    const   F_TILEBOI_HI9_TE7_LA3_TLX_TLY_DPC = function         //      [162]
    PRIVATE_F_TILEBOI_HI9_TE7_LA3_TLX_TLY_DPC(                   //      [162]
                                                                 //      [162]
        i_hi9       //: Which Of The 9 Hotels Are We In? ://     //      [162]
    ,   i_te7       //: What Tile Size Are We Using?     ://     //      [162]
    ,   i_la3       //: Data Layer? Tiles,Bombs,Fada?    ://     //      [162]
    ,   i_tlx       //: Tile Local X (LevelPackLocal)    ://     //      [162]
    ,   i_tly       //: Tile Local Y (LevelPackLocal)    ://     //      [162]
    ){                                                           //      [162]
        if( d_eci >= 1 ){                                        // [166]
                                                                 // [166]
            ASS( i_hi9 >= 0 && i_hi9 <= (9-1)     );             // [166]
            let    h3x =(           ( i_hi9 % 3 ) );             // [166]
            let    h3y =Math.floor( ( i_hi9 / 3 ) );             // [166]
            ASS(   h3x >= 0 && h3x <= (3-1) );                   // [166]
            ASS(   h3y >= 0 && h3y <= (3-1) );                   // [166]
                                                                 // [166]
            ASS( i_te7 >= 0 && i_te7 <=(7-1) , "[TE7_166]");     // [166]
            ASS( i_la3 >= 0 && i_la3 <=(3-1) , "[LA3_166]");     // [166]
                                                                 // [166]
            let lateral_span_of_dataset = d_te7_lat[ i_te7 ];    // [166]
            let lahotel =( 5 * lateral_span_of_dataset );        // [166]
            ASS( i_tlx >=(    0    ) , "[TLX:VID_162]" );        // [166]
            ASS( i_tly >=(    0    ) , "[TLY:VID_162]" );        // [166]
            ASS( i_tlx <=(lahotel-1) , "[TLX:VID_162]" );        // [166]
            ASS( i_tly <=(lahotel-1) , "[TLY:VID_162]" );        // [166]
        };;                                                      // [166]
        var o_dpc =(0-666); //:@o_dpc@:OutputDataPixelCom://     //      [162]
                                                                 // [---]
        var   dpx =(   0 ); //: @dpx@ : DataPixel - X    ://     // [166]
        var   dpy =(   0 ); //: @dpy@ : DataPixel - Y    ://     // [166]
        var   dpi =(   0 ); //: @dpi@ : DataPixel - I    ://     // [166]
        ///   dpc =(   0 ); //: @dpc@ : DataPixel - C    ://     // [166]
                                                                 // [166]

        //:#_MULTISECTION_LAT_#:[171]:-------------------://     // [---]
            const                                                // [171][---]
                lat = d_te7_lat[ i_te7 ];//:#TAG_TE7_LAT#://     // [171][166]
                                                                 // [---]
        //:-------------------:#_MULTISECTION_LAT_#:[171]://     // [---]
        //:(MEM_CEL):[166]:------------------------------://     // [166]
        //:(HOT_CEL):[167]:------------------------------://     // [---]
                                                                 //      [166]
            //:::::::::::::::::::::::::::::::::::::::::::://     // [167]
            //: Get Master Memory Cell Storing Hotel ::::://     //      [166]
            //:::::::::::::::::::::::::::::::::::::::::::://     // [167]
            //: A[HOT_CEL] is a[MEM_CEL] but a[MEM_CEL]  ://     // [167]
            //: is not necessarily a[HOT_CEL]            ://     // [167]
            //:::::::::::::::::::::::::::::::::::::::::::://     // [167][---]
                                                                 //           [166]
            var mmx = d_hi9_mmx[ i_hi9 ]; //: MEM_CEL.X  ://     // [171][FIX][166]
            var mmy = d_hi9_mmy[ i_hi9 ]; //: MEM_CEL.Y  ://     // [171][FIX][166]
                                        //:#DIA_MMX_MMY# ://     //      [---][166]
                                                                 //      [---][166]
        //:------------------------------:(HOT_CEL):[167]://     // [---][---]
        //:------------------------------:(MEM_CEL):[166]://     // [166][---]
        ...
        //:(ROM_CEL):[167]:------------------------------://     // [167][---]
                                                                 //      [---][166]
            //: Get Cell Storing Room In Hotel([r5x,r5y])://     //      [---][166]
                                                                 //      [---][166]
            let M_F =( Math.floor );     //:#DIA_ROM_CEL#://     // [167][---][166]
            var r5x =    M_F( i_tlx / lat ); //:#TAG_R5X#://     //      [---][166]
            var r5y =    M_F( i_tly / lat ); //:#TAG_R5Y#://     //      [---][166]
                                                                 //      [---][166]
            if( d_bug >= 1 ){                                    // [---][---][166]
                if( (!( r5x >= 0 && r5x <=(5-1) ))               // [171][---][166]
                ||  (!( r5y >= 0 && r5y <=(5-1) ))               // [171][---][166]
                ){                                               // [171][---][166]
                    if( Number.isNaN( r5x ) ){                   // [171][---][---]
                        console.log("[r5x_is_nan_number]");      // [171][---][---]
                    };;                                          // [171][---][---]
                    if( Number.isNaN( r5y ) ){                   // [171][---][---]
                        console.log("[r5y_is_nan_number]");      // [171][---][---]
                    };;                                          // [171][---][---]
                                                                 // [171][---][---]
                    LOG( "[R5X_VAL]::" , r5x );                  // [171][---][---]
                    LOG( "[R5Y_VAL]::" , r5y );                  // [171][---][---]
                    ERR( "[OOB_R5X_ORR_R5Y]" );                  // [171][---][166]
                };;                                              // [171][---][166]
            };;                                                  // [---][---][166]
            var g25 =( r5x +( r5y * 5 ) ); //:(r5i===g25)://     // [---][---][166]
                                                                 // [---][---][166]
            if( d_bug >= 1 ){                                    // [---][---][166]
                ASS( g25 >= 0 && g25 <=(25-1) , "[!G25!]" );     // [---][---][166]
            };;                                                  // [---][---][166]
                                                                 // [---][---][166]
            //:------------------------------------------://     // [---][---][166]
            //: SEE[ TAG_R4X_R4Y ]                       ://     // [---][---][166]
            //:------------------------------------------://     // [---][---][166]
            //: [r4x,r4y] is the [DAT]a   position.      ://     // [---][---][166]
            //: [r5x,r5y] is the [REN]der position.      ://     // [---][---][166]
            //:---------------------------:              ://     // [---][---][166]
                                        //: [DAT]!=[REN] ://     // [---][---][166]
            var r4x = d_g25_r4x[ g25 ]; //:  r4x != r5x  ://     // [---][---][166]
            var r4y = d_g25_r4y[ g25 ]; //:  r4y != r5y  ://     // [---][---][166]
            var rdi = d_g25_r13[ g25 ]; //:--------------://     // [171][FIX][166]
                                                                 // [---]
            if( d_bug >= 1 ){ //:------------------------://     // [171][---]
                                                                 // [171][---]
                let chk =( r4x + ( r4y * 4 ) );                  // [171][---]
                if( chk !== rdi ){                               // [171][---]
                                                                 // [171][---]
                    LOG( "[...:g25]:" , g25 );                   // [171][---]
                    LOG( "[...:r4x]:" , r4x );                   // [171][---]
                ...
                ASS( r4x + ( r4y * 4 )===rdi,"[RDI_2022]" );     // [---][166]
                                                                 // [---][---]
            };; //:--------------------------------------://     // [171][---]
                                                                 //      [166]
        //:------------------------------:(ROO_CEL):[167]://     // [167]
        ...
        //:(TIL_SIZ):[166]:------------------------------://     // [---][---][166]
                                                                 // [---][---][166]
            var dia = d_te7_dia[ i_te7 ];//:#TAG_TE7_DIA#://     // [---][---][166]
                                                                 // [---][---][166]
        //:------------------------------:(TIL_SIZ):[166]://     // [---][---][166]
        //:(TIL_LAY):[166]:------------------------------://     // [---][---][166]
                                                                 // [---][---][166]
            //:::::::::::::::::::::::::::::::::::::::::::://     // [---][---][166]
            //: Offset Into Correct Layer Of Data        ://     // [---][---][166]
            //: Offset To Data X === layer_x             ://     // [---][---][166]
            //: Offset To Data Y === layer_y             ://     // [---][---][166]
            //:::::::::::::::::::::::::::::::::::::::::::://     // [---][---][166]
            //: if [lmx,lmy]===[0,0], THEN : TILES layer ://     // [---][---][166]
            //: if [lmx,lmy]===[1,0], THEN : BOMBS layer ://     // [---][---][166]
            //: if [lmx,lmy]===[0,1], THEN : FADA  layer ://     // [---][---][166]
            //:::::::::::::::::::::::::::::::::::::::::::://     // [---][---][166]
                                                                 // [---][---][166]
            var lmx = d_la3_lmx[ i_la3 ];//:#TAG_TE7_LMX#://     // [---][---][166]
            var lmy = d_la3_lmy[ i_la3 ];//:#TAG_TE7_LMY#://     // [---][---][166]
                                                                 // [---][---][166]
            var layer_x =( lat * lmx );                          // [---][---][166]
            var layer_y =( lat * lmy );                          // [---][---][166]
                                                                 // [---][---][166]
            if( d_bug >= 1 ){                                    // [---][---][166]
                                                                 // [---][---][166]
                ASS( lmx + lmy >= 0 , "[LAYCHK1:LOW]" );         // [171][FIX][166]
                ASS( lmx + lmy <= 1 , "[LAYCHK1:HIG]" );         // [171][FIX][166]
            };;                                                  // [---][---][166]
        //:------------------------------:(TIL_LAY):[166]://     // [---][---][166]
        //:(TXY):[166]:----------------------------------://     // [---][---][166]
                                                                 // [---][---][166]
            //: Get [ room/level ]local tile( [t_x,t_y] )://     // [---][---][166]
                                                                 // [---][---][166]
            var t_x = i_tlx - ( r5x * lat );                     // [---][---][166]
            var t_y = i_tly - ( r5y * lat );                     // [---][---][166]
                                                                 // [---][---][166]
        //:----------------------------------:(TXY):[166]://     // [---][---][166]
        //:ALL_TOGETHER_NOW:[166]:-----------------------://     // [---][---][166]
                                                                 // [---][---][166]
        //:  (MEM_CEL)+(LEV_CEL)+(TIL_SIZ)+(TIL_LAY)+(TXY)://    // [167][166]
        //:  (HOT_CEL)+(ROM_CEL)+(TIL_SIZ)+(TIL_LAY)+(TXY)://    // [167][---]
        dpx =(mmx*512)+(r4x*128)+(  dia  )+(layer_x)+(t_x);      //      [166]
        dpy =(mmy*512)+(r4y*128)+(  dia  )+(layer_y)+(t_y);      //      [166]
                                                                 //      [166]
        //:-----------------------:ALL_TOGETHER_NOW:[166]://     //      [166]
        //:MULTIPLY_BY_FOR_YOU_FOOL:[166]:---------------://     //      [166]
                                                                 //      [166]
            dpi =( dpx + ( dpy * 2048 ) ); //: @PIX_DEX@ ://     //      [166]
          o_dpc =( 4 * dpi ); //:< < < < < < < @PIX_COM@ ://     //      [166]
                                                                 //      [166]
        //:---------------:MULTIPLY_BY_FOR_YOU_FOOL:[166]://     //      [166]
                                                                 // [---]
        return( o_dpc );                                         //      [162]
                                                                 // [---][---]
    };; //:ENDFUNC[ HI9_TE7_LA3_TLX_TLY_DPC ]::::::::::::://     // [171][162]
                                                                 //      [162]
    //:------------------:Calc_Data_Pixel_Component:[162]://     //      [162]
                                                                 // [---]
    //:--------------------------------------------------://     // [161]
    ...
    ,   i_u32        //:<--Raw_U32_Tile_Value                :// // [161]
                     //:-------------------------------------:// // [161]
                                                                 ...
                                                                 // [---]
        var   o_k =( 1 );   //: Don't Continue If Not OK ://     // [168][162]
                                                                 // [162]
        const te7 =(            i_te7   );                       // [162]
        const la3 =(            i_la3   );                       // [162]
        const lat =( d_te7_lat[ i_te7 ] );                       // [162]
                                                                 // [162]
        const gmi     =((3*5*lat)-1); //:@gmi@:GlobalMaxIndex:// // [162]
        const lahotel =(   5*lat   ); //:Lateral_Span:HOTEL  :// // [162]
                                                                 // [162]
        if( ( i_gtx < 0 ) || ( i_gtx > gmi )                     // [162]
        ||  ( i_gty < 0 ) || ( i_gty > gmi )                     // [162]
        ){                                                       // [162]
            //:::::::::::::::::::::::::::::::::::::::::::://     // [162]
            //: Do nothing, out of bounds.               ://     // [162]
            //: No failing fast for out of bounds input. ://     // [162]
            //:::::::::::::::::::::::::::::::::::::::::::://     // [162]
            o_k=( 0 );                                           // [162]
        };;                                                      // [162]
                                                                 // [162]
        if( o_k >= 1 ){                                          // [162]
                                                                 // [162]
            var h3x = ( Math.floor( i_gtx / lahotel ) );         // [162]
            var h3y = ( Math.floor( i_gty / lahotel ) );         // [162]
            var hi9 = ( h3x + ( h3y * 3 ) );                     // [162]
            var tlx = ( i_gtx - (     h3x * lahotel ) );         // [162]
            var tly = ( i_gty - (     h3y * lahotel ) );         // [162]
            var r5x = ( Math.floor(   tlx / lat     ) );         // [162]
            var r5y = ( Math.floor(   tly / lat     ) );         // [162]
            var g25 = ( r5x + ( r5y * 5 ) );                     // [162]
                                                                 // [162]
            ASS( h3x >= 0 && h3x <= (      3-1) , "[E_P:h3x]" ); // [162]
            ASS( h3y >= 0 && h3y <= (      3-1) , "[E_P:h3y]" ); // [162]
            ASS( hi9 >= 0 && hi9 <= (      9-1) , "[E_P:hi9]" ); // [162]
            ASS( tlx >= 0 && tlx <= ((5* 64)-1) , "[E_P_TLX]" ); // [162]
            ASS( tly >= 0 && tly <= ((5* 64)-1) , "[E_P_TLY]" ); // [162]
            ASS( tlx >= 0 && tlx <= ((5*lat)-1) , "[E_P:tlx]" ); // [162]
            ASS( tly >= 0 && tly <= ((5*lat)-1) , "[E_P:tly]" ); // [162]
            ASS( r5x >= 0 && r5x <= (      5-1) , "[E_P:r5x]" ); // [162]
            ASS( r5y >= 0 && r5y <= (      5-1) , "[E_P:r5y]" ); // [162]
            ASS( g25 >= 0 && g25 <= (     25-1) , "[E_P:g25]" ); // [162]
                                                                 // [162]
            var vod = d_g25_vod[ g25 ];                          // [162]
            if( vod ){ o_k =( 0 ); };                            // [162]
        };;                                                      // [162]
        if( o_k >= 1 ){                                          // [162]
                                                                 // [162]
            //:-------------------------------://                // [162]
            //: @dpc@ : Data_Pixel_Component  ://                // [162]
            //: @dpi@ : Data_Pixel_Index      ://                // [162]
            //:  dpi * 4 === dpc              ://                // [162]
            //:-------------------------------://                // [162]
                                                                 // [162]
            var dpc = F_TILEBOI_HI9_TE7_LA3_TLX_TLY_DPC(         // [162]
                                hi9,te7,la3,tlx,tly              // [162]
            );;                                                  // [162]
            ASS( dpc >= 0 && dpc <= ((4*2048*2048)-1)            // [162]
            ,   "[EDI_PUT_U32:OOB_DPC]" );;                      // [162]
                                                                 // [---]
            //:_P2K_section_has_INVERSE_:[168]:--------------:// // [168]
            let p2k = d_pix2048 ; //:@FOR@:P2K_PUT_U32://        // [168]
                                  //:@REL@:P2K_GET_U32://        // [168]
                                                                 // [168]
            //: #_TILE_PUT_BIT_UN_PACK_DIAGRAM_#  @BITLOGIC@ :// // [168]
                                                                 // [168]
            p2k[ dpc+0 ]=( i_u32 >>> 24 )&(0xFF) ; //:@RBS_R@:// // [168]
            p2k[ dpc+1 ]=( i_u32 >>> 16 )&(0xFF) ; //:@RBS_G@:// // [168]
            p2k[ dpc+2 ]=( i_u32 >>>  8 )&(0xFF) ; //:@RBS_B@:// // [168]
            p2k[ dpc+3 ]=( i_u32 >>>  0 )&(0xFF) ; //:@RBS_A@:// // [168]
                                                                 // [168]
            //:--------------:_P2K_section_has_INVERSE_:[168]:// // [168]
                                                                 // [---]
        };; //:[ ? o_k ? ]::::::::::::::::::::::::::::::::::::// // [162]
                                                                 // [---]
    };;     //:ENDOF[ EDI_PUT_U32 ]:::::::::::::::::::::::::::// // [162][161]
    const   F_TILEBOI_EDI_GET_U32 = function                     //      [161]
    PRIVATE_F_TILEBOI_EDI_GET_U32(    //:TAG[ FTB_ES_PG_U32 ]:// //      [161]
                     //:-------------------------------------:// //      [161]
        i_te7,i_la3  //:<--TileSize_And_Layer                :// //      [161]
    ,   i_gtx,i_gty  //:<--Dum_Global_Coordinate             :// //      [161]
    //- i_u32     -////:<--Raw_U32_Tile_Value (#FIX_003#)    :// // [168][161]
                     //:-------------------------------------:// //      [161]
    ){                                                           //      [161]
                                                                 // [---]
                          //:----------------------------://     // [168]
        var o_u32 =( 0 ); //: Output pixel as U32        ://     // [168]
                          //: If GET Out Of Bounds,      ://     // [168]
                          //: should return ZERO.        ://     // [168]
        ...
        if( o_k >= 1 ){                                          // [162]
            ...
            var g25 = ( r5x + ( r5y * 5 ) );                     // [162]
                                                                 // [162]
            ASS( h3x >= 0 && h3x <= (      3-1) , "[E_G:h3x]" ); // [162]
            ASS( h3y >= 0 && h3y <= (      3-1) , "[E_G:h3y]" ); // [162]
            ASS( hi9 >= 0 && hi9 <= (      9-1) , "[E_G:hi9]" ); // [162]
            ASS( tlx >= 0 && tlx <= ((5* 64)-1) , "[E_G_TLX]" ); // [162]
            ASS( tly >= 0 && tly <= ((5* 64)-1) , "[E_G_TLY]" ); // [162]
            ASS( tlx >= 0 && tlx <= ((5*lat)-1) , "[E_G:tlx]" ); // [162]
            ASS( tly >= 0 && tly <= ((5*lat)-1) , "[E_G:tly]" ); // [162]
            ASS( r5x >= 0 && r5x <= (      5-1) , "[E_G:r5x]" ); // [162]
            ASS( r5y >= 0 && r5y <= (      5-1) , "[E_G:r5y]" ); // [162]
            ASS( g25 >= 0 && g25 <= (     25-1) , "[E_G:g25]" ); // [162]
                                                                 // [162]
            var vod = d_g25_vod[ g25 ];                          // [162]
            if( vod ){ o_k =( 0 ); };                            // [162]
                                                                 // [162]
        ...
        if( o_k >= 1 ){                                          // [162]
            ...
            ASS( dpc >= 0 && dpc <= ((4*2048*2048)-1)            // [162]
            ,   "[EDI_GET_U32:OOB_DPC]" );;                      // [162]
                                                                 // [---]
            //:_P2K_section_has_INVERSE_:[168]:--------------:// // [168]
            let p2k = d_pix2048 ;        //:@FOR@:P2K_GET_U32:// // [168]
                                         //:@REL@:P2K_PUT_U32:// // [168]
                                                                 // [168]
            //: #_TILE_GET_BIT____PACK_DIAGRAM_#  @BITLOGIC@ :// // [168]
                                                                 // [168]
            o_u32 =(( 0x00                                       // [168]
            |    ( ( p2k[ dpc+0 ] )<< 24 )//:@LEF_S_R@://        // [168]
            |    ( ( p2k[ dpc+1 ] )<< 16 )//:@LEF_S_G@://        // [168]
            |    ( ( p2k[ dpc+2 ] )<<  8 )//:@LEF_S_B@://        // [168]
            |    ( ( p2k[ dpc+3 ] )<<  0 )//:@LEF_S_A@://        // [168]
            ) >>> 0 );;                                          // [168]
            //:--------------:_P2K_section_has_INVERSE_:[168]:// // [168]
                                                                 // [---]
        };; //:[ ? o_k ? ]::::::::::::::::::::::::::::::::::::// // [162]
        ...
        return( o_u32 ); //: OUTPUT_PIXEL_AS_U32 ://             // [168]

    };;     //:ENDOF[ EDI_GET_U32 ]:::::::::::::::::::::::::::// // [162][161]
    ...
    PRIVATE_F_KONAMIC_EVT_KEY(                                   // [180]
        ...
        if( d_konamic_act >= 1 /** Konami code Active ? **/ ){   //      [181]
            ...
            ERR("[INVALID_KONAMIC_CASE_2022]");                  // [181]
                                                                 ...
                                                                 // [---]
        MSG( "[TO_FUCKING_DO:2022_08_22]" );                     // [180]
    };;                                                          // [180]
                                                                 // [180]
//|--|--|--|--|--|--|--|--|--|SUBS|--|--|--|--|--|--|--|--|--|// // [180]
//|                                               [ @$$$$$@ ]|// // [180]
