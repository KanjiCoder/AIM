...
//|--|--|--|--|--|--|--|--|--|SUBS|--|--|--|--|--|--|--|--|--|// // [156]
    ...
    ,   i_tly       //: Tile Local Y (LevelPackLocal)    ://     //      [162]
        ...
        ///   dpc =(   0 ); //: @dpc@ : DataPixel - C    ://     // [166]
                                                                 // [166]
        var mmx = d_hi9_mmx[ hi9 ]; //:MasterMemoryCell.X://     // [166]
        var mmy = d_hi9_mmy[ hi9 ]; //:MasterMemoryCell.Y://     // [166]
                                    //:#DIAGRAM_MMX_MMY# ://     // [166]
                                                                 // [166]
        ...
        var r5y =    M_F( i_tly / lat ); //:#TAG_R5Y#    ://     // [166]
                                                                 // [166]
        if( d_bug >= 1 ){                                        // [166]
        ASS(r5x >= 0 && r5x <=(5-1) , "[OOB______R5X]" );        // [166]
        ASS(r5y >= 0 && r5y <=(5-1) , "[OOB______R5Y]" );        // [166]
        };;                                                      // [166]
        var g25 = ( r5x + ( r5y * 5 ) ); //:( r5i===g25 )://     // [166]
                                                                 // [166]
        if( d_bug >= 1 ){                                        // [166]
            ASS( g25 >= 0 && g25 <=(25-1) , "[OOB_G25]" );       // [166]
        };;                                                      // [166]
        ...
        ASS( r4x + ( r4y * 4 ) === rdi , "[R4X_R4Y_4_RDI]" );    // [166]
                                                                 // [166]
        dpx = (mmx*512)+(r4x*128)+dia+(lat*lmx)+t_x ;            // [166]
        dpy = (mmy*512)+(r4y*128)+dia+(lat*lmy)+t_y ;            // [166]
                                                                 // [166]
