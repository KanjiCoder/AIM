        ...
        //:use_the_sample_point:[099]:-----------------------://// [099]
            ...
            #define e_bot ( d_vpc[ y_1 ]- c_w[ y_1 ] + u_1 )    // [122]
                ...
                F32 f_bot =( F32(e_bot) / f_c_m );              // [123]
                                                                // [123]
                F32 f_vpc_wid_haf =(                            // [123]
                                                                // [123]
                    F32( d_vpc[ x_1 ] - d_vpc[ x_0 ] + u_1 )    // [123]
                    /                                           // [123]
                    f_2                                         // [123]
                );;                                             // [123]
                F32 f_vpc_hig_haf =(                            // [123]
                                                                // [123]
                    F32( d_vpc[ y_1 ] - d_vpc[ y_0 ] + u_1 )    // [123]
                    /                                           // [123]
                    f_2                                         // [123]
                );;                                             // [123]
                U32 u_lef =U32( f_lef * (f_vpc_wid_haf) );      // [123]
                U32 u_top =U32( f_top * (f_vpc_wid_haf) );      // [123]
                U32 u_rig =U32( f_rig * (f_vpc_hig_haf) );      // [123]
                U32 u_bot =U32( f_bot * (f_vpc_hig_haf) );      // [123]
