...
//:                                                          :// // [102]
//: SOURCE__CODE : github.com/KanjiCoder/AIM_147             :// // [147][146][145][144][143][142][141][140][139][138][137][136][135][134][133][132][131][130][129][128][127][126][125][124][122][121][120][119][117][116][115][113][112][111][110][109][108][107][106][105][104][103][102][100][099][098][097][096][095][094][093][092][091][090][089][088][087][086][085][084][083][082][081][080][079]                               
...
(c_artgirl_wgl_tag+`                                            // [074]   
    ...
    //: u_dup =( DiscreteUnitSelection )/( NumPixelsOnScreen ); // [097]
        ...
        //:use_the_sample_point:[099]:-----------------------://// [099]
            ...
            //:cursor_dot:[147]:-------------------------://    // [---]
            if( 1 != 1                                          // [147]
            || abs( I32( u_dsc.x ) - I32( d_m_x ) ) < 16        // [147]
            || abs( I32( u_dsc.y ) - I32( d_m_y ) ) < 16        // [147]
            ){                                                  // [147]
                out_f_c.r =( 1.0             );                 // [147]
    ...
    PRIVATE_F_MOUMAST_P_X_DUX(                                   // [145]
        ...
        ||  i_p_x >= d_can.width  //: #PT_OOB_OF_CANVAS# ://     // [146]    
            ...
            //: @DO_CALC_BAKWARD_WITH@[ vp1 ] ://                // [146]
                                                                 // [146]
                var vp1_wid =( d_vp1[ x_1 ]-d_vp1[ x_0 ]+1 )+0.0;    // [148][146]
                var vp1_pos =( ( vp1_wid - 1 ) * f_x       )+0.0;    // [148][146]
