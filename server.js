        ...
        if( o_k >= 1 ){                                          // [185][MOV][162]
            ...
            if( d_bug >= 1 ){                                    // [197][--------]
                ...
                ASS_INT( dpc/4 , "[DV4_NOT_INT]" );              // [197][--------]
                                                                 // [197][--------]
                let dpi = (     ( dpc /    4 ) ); ASS_I32(dpi);  // [197][--------]
                let dpx = (     ( dpi % 2048 ) );                // [197][--------]
                let dpy = (F_M_F( dpi / 2048 ) );                // [197][--------]
                                                                 // [197][--------]
                let got_h3x =( dpx / 512 );                      // [197][--------]
                let got_h3y =( dpy / 512 );                      // [197][--------]
                                                                 // [197][--------]
                if( got_h3x < 0 || got_h3x >= (3-1)              // [197][--------]
                ||  got_h3y < 0 || got_h3y >= (3-1)              // [197][--------]
                ){                                               // [197][--------]
