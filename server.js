...
//:TOP_LEVEL_VARIABLES:[088]:================================://    [---]
    ...
    ,   0 + 64                       //: ( 0 )==>( _64 ) ://     // [165]
    ,   0 + 64 + 32                  //: ( 0 )==>( _96 ) ://     // [165]
    ,   0 + 64 + 32 + 16             //: ( 0 )==>( 112 ) ://     // [165]
    ,   0 + 64 + 32 + 16 + 8         //: ( 0 )==>( 120 ) ://     // [165]
    ,   0 + 64 + 32 + 16 + 8 + 4     //: ( 0 )==>( 124 ) ://     // [165]
    ,   0 + 64 + 32 + 16 + 8 + 4 + 2 //: ( 0 )==>( 126 ) ://     // [165]
    ]);;                                                         // [165]
    {                                                            // [165]
    ...
    {                                                            // [165]
        ...
        let lmy = d_la3_lmy   ; //:  [ #DIAGRAM_TE7_LAT#]://     // [165]
                                //:----------------------://     // [165]
...
//|--|--|--|--|--|--|--|--|--|SUBS|--|--|--|--|--|--|--|--|--|// // [156]
    ...
    ,   i_tly       //: Tile Local Y (LevelPackLocal)    ://     // [162]
        ...
        var o_dpc =(0-666); //:@o_dpc@:OutputDataPixelCom://     // [162]
                                                                 // [---]
        //# OKAY. I SWEAR WE DO THIS NEXT VIDEO!!!( 1_6_6 ) #//  // [165]
                                                                 // [---]
        return( o_dpc );                                         // [162]
    };;                                                          // [162]
                                                                 // [162]
  ...
  -=-   +---------------------+  g25 : GridIndexes : 0-to-24   :   [163][087]
    ...
    #DIAGRAM_TE7_LMY# :---------------------------------------+  // [165]
      ...
      [TIL]===[0,0]   [BOM]===[128,000]                       |  // [165]
        ...
        :-----------------------------------------------------+  // [165]
                                                              |  // [165]
        te7_lmx[ c_lay_til ] ==> te7_lmx[0] ==> 0             |  // [165]
        te7_lmy[ c_lay_til ] ==> te7_lmy[0] ==> 0             |  // [165]
        SO:      c_lay_til   =================> #CEL_0_0#     |  // [165]
                                                              |  // [165]
        te7_lmx[ c_lay_bom ] ==> te7_lmx[1] ==> 1             |  // [165]
        te7_lmy[ c_lay_bom ] ==> te7_lmy[1] ==> 0             |  // [165]
        SO:      c_lay_bom   =================> #CEL_1_0#     |  // [165]
                                                              |  // [165]
        te7_lmx[ c_lay_fad ] ==> te7_lmx[2] ==> 0             |  // [165]
        te7_lmy[ c_lay_fad ] ==> te7_lmy[2] ==> 1             |  // [165]
        SO:      c_lay_fad   =================> #CEL_0_1#     |  // [165]
                                                              |  // [165]
        :-----------------------------------------------------+  // [165]
                                                              |  // [165]
        [TIL]===[000,0]===[ lat*te7_lmx[0] , lat*te7_lmy[0] ] |  // [165]
        [TIL]===[000,0]===[ 128*(   0    ) , 128*(   0    ) ] |  // [165]
        [TIL]===[000,0]===[ (     000    ) , (     000    ) ] |  // [165]
                                                              |  // [165]
        [BOM]===[128,0]===[ lat*te7_lmx[1] , lat*te7_lmy[1] ] |  // [165]
        [BOM]===[128,0]===[ 128*(   1    ) , 128*(   0    ) ] |  // [165]
        [BOM]===[128,0]===[ (     128    ) , (     000    ) ] |  // [165]
                                                              |  // [165]
        [FAD]===[0,128]===[ lat*te7_lmx[2] , lat*te7_lmy[2] ] |  // [165]
