...
//|--|--|--|--|--|--|--|--|--|SUBS|--|--|--|--|--|--|--|--|--|// // [185][MOV][156]
    ...
    ,   i_u32        //:<--Raw_U32_Tile_Value                :// // [185][MOV][161]
        ...
        if( o_k >= 1 ){                                          // [185][MOV][162]
            ...
            i_r = i_g = i_b = i_a =( 255 );
                                                                 // [---][--------]
            d_pix2048[ dpc+0 ]=( i_r ) ; A_B( i_r,"[@RBS_R@]" ); // [185][MOV][168]
            d_pix2048[ dpc+1 ]=( i_g ) ; A_B( i_g,"[@RBS_G@]" ); // [185][MOV][168]
            d_pix2048[ dpc+2 ]=( i_b ) ; A_B( i_b,"[@RBS_B@]" ); // [185][MOV][168]
            d_pix2048[ dpc+3 ]=( i_a ) ; A_B( i_a,"[@RBS_A@]" ); // [185][MOV][168]
                                                                 // [---][--------]
            d_pix2048_dir =( 1 );                                // [197][--------]
                                                                 // [185][MOV][168]
            //:--------------:_P2K_section_has_INVERSE_:[168]:// // [185][MOV][168]
