...
//|--|--|--|--|--|--|--|--|--|SUBS|--|--|--|--|--|--|--|--|--|// // [180]
    ...
    PRIVATE_F_KONAMIC_EVT_KEY(                                   // [180]
        ...
        var kon_act =( 0 /** Konamic Just Activated?**/ );
        ...
        if( 1 === 1 ){                                           // [187][181]
            ...
            let dex , din , inv ;                                // [187]
            let ptr_ark   ; //:Arrow Key Pointer         ://     // [187]
            let ptr_win   ; //:Scrolling Window Pointer  ://     // [187]
            ...
            for( dex = 0 ; dex <= c_konamic_m_i ; dex ++ ){      // [187]
                ...
                ptr_win = din ;                                  // [187]
                                                                 // [187]
                ark_exp =( d_konamic_ark[ ptr_ark] );            // [187]
                ark_got =( d_konamic_win[ ptr_win] );            // [187]
                                                                 // [187]
