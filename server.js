    ...
    //: u_dup =( DiscreteUnitSelection )/( NumPixelsOnScreen ); // [097]
        ...
        //:use_the_sample_point:[099]:-----------------------://// [099]
            ...
            //::::::::::::::::::::::::::::::::::::::::::::://
                                                                // [099]
            //:::::::::::::::::::::::::::::::::::::::::::::::://
            //: What things does the sample point belong to? ://
            //:::::::::::::::::::::::::::::::::::::::::::::::://
            ...
            //:::::::::::::::::::::::::::::::::::::::::::::::://
            //: Convert XY Coordinates To 1D Index Coords    ://
            //: (Not used yet, but will be used to fetch )   ://
            //: (data eventually. )                          ://
            //:::::::::::::::::::::::::::::::::::::::::::::::://

            U32 h09 = u_h03.x + ( u_h03.y * u_3 ) ;
            ...
            //::::::::::::::::::::::::::::::::::::::::::::://
            //: @i_h01@/@h01@ : Hotel Coord As [ 0 || 1 ] ://
            //: @i_r01@/@r01@ : Room  Coord As [ 0 || 1 ] ://
            //: @i_t01@/@t01@ : Tile  Coord As [ 0 || 1 ] ://
            //::::::::::::::::::::::::::::::::::::::::::::://
            ...
            I32 i_r01 =abs(
                I32( u_r05.x -(( u_r05.x / u_2)*u_2)) //:MOD2://
            -   I32( u_r05.y -(( u_r05.y / u_2)*u_2)) //:MOD2://
            );;
            I32 i_t01 =abs(
                I32( u_t64.x -(( u_t64.x / u_2)*u_2)) //:MOD2://
            -   I32( u_t64.y -(( u_t64.y / u_2)*u_2)) //:MOD2://
            );;
            ...
            out_f_c =FV4(                                       // [099]
                                                                // [099]
                F32(   F32( i_255 * i_h01 ) / f_255 )           // [099]
            ,   F32(   F32( i_255 * i_r01 ) / f_255 )           // [099]
            ,   F32(   F32( i_255 * i_t01 ) / f_255 )           // [099]
            ,   1.0                                             // [099]
            );;                                                 // [099]
                                                                // [099]
        //:-----------------------:use_the_sample_point:[099]://// [099]
