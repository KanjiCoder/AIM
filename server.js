...
//: __KONAMIC__ V_V_V_V_V_V_V_V_V_V_V_V_V_V_V_V_V_V_V_V_V_V_V:// // [180]
    ...
    const c_konamic_dum_000 =( 4 ); //:[ dum_tog ](  Toggle ):// // [199][---]
    const c_konamic_dum_001 =( 5 ); //:[ del_b_l ][ fil_b_l ]:// // [199][---]
    const c_konamic_dum_002 =( 6 ); //:[ del_b_m ][ fil_b_m ]:// // [199][---]
    const c_konamic_dum_003 =( 7 ); //:[ del_b_r ][ fil_b_r ]:// // [199][---]
    const c_konamic_dum_004 =( 8 ); //:[ del_c_l ][ fil_c_l ]:// // [199][---]
    const c_konamic_dum_005 =( 9 ); //:[ del_c_m ][ fil_c_m ]:// // [199][---]
    const c_konamic_dum_006 =(10 ); //:[ del_c_r ][ fil_c_r ]:// // [199][---]
    const c_konamic_dum_007 =(11 ); //:[ del_t_l ][ fil_t_l ]:// // [199][---]
    const c_konamic_dum_008 =(12 ); //:[ del_t_m ][ fil_t_m ]:// // [199][---]
    const c_konamic_dum_009 =(13 ); //:[ del_t_r ][ fil_t_r ]:// // [199][---]
...
(c_artgirl_wgl_tag+`                                             // [074]   
    ...
    #define GET_P2K_FV4 "[FIX:GET__LA3__FV4]"  //: @MWM@ ://     // [204][175]
    #define GET_FV4_P2K "[FIX:GET__LA3__FV4]"  //: @MWM@ ://     // [204][175]
    #define GET_FV4_LA3 "[FIX:GET__LA3__FV4]"  //: @MWM@ ://     // [204][175]
                                                                 // [---][---]
...
//|--|--|--|--|--|--|--|--|--|SUBS|--|--|--|--|--|--|--|--|--|// // [180]
    ...
    ,   i_h3y                                                    // [202]
        ...
        if( 0 === d_konamic_h3x_h3y_tog ){                       // [202]
                                                                 // [202]
            F_PIX2048_H3X_H3Y_U32( i_h3x , i_h3y , 0x00000000 ); // [202]
        }else                                                    // [202]
        if( 1 === d_konamic_h3x_h3y_tog ){                       // [202]
                                                                 // [202]
            F_PIX2048_H3X_H3Y_U32( i_h3x , i_h3y , 0xFFFFFFFF ); // [202]
        }else{                                                   // [202]
    ...
    PRIVATE_F_KONAMIC_EVT_KEY(                                   // [180]
        ...
        if( d_konamic_act >= 1 /** Konami code Active ? **/ ){   //      [181]
            ...
            if( konamic_listening_to_numpad  ){                  // [203]
                                                                 // [203]
                n10 = F_KEYMAST_EVT_N10( i_evt_key );            // [203]
            ...
            if( (k26_has)||(n10_has) ){                          // [202][--------]
                ...
                if( c_konamic_dum_001 === enuproc ){ /////////// // [202][--------]
                                                                 // [202][--------]
                    F_KONAMIC_H3X_H3Y_TOG(0,2);    //:@B___L@:// // [202][--------]
                }else                                            // [202][--------]
                if( c_konamic_dum_002 === enuproc ){ /////////// // [202][--------]
                                                                 // [202][--------]
                    F_KONAMIC_H3X_H3Y_TOG(1,2);    //:@B___M@:// // [202][--------]
                }else                                            // [202][--------]
                if( c_konamic_dum_003 === enuproc ){ /////////// // [202][--------]
                                                                 // [202][--------]
                    F_KONAMIC_H3X_H3Y_TOG(2,2);    //:@B___R@:// // [202][--------]
                }else                                            // [202][--------]
                if( c_konamic_dum_004 === enuproc ){ /////////// // [202][--------]
                                                                 // [202][--------]
                    F_KONAMIC_H3X_H3Y_TOG(0,1);    //:@C___L@:// // [202][--------]
                }else                                            // [202][--------]
                if( c_konamic_dum_005 === enuproc ){ /////////// // [202][--------]
                                                                 // [202][--------]
                    F_KONAMIC_H3X_H3Y_TOG(1,1);    //:@C___M@:// // [202][--------]
                }else                                            // [202][--------]
                if( c_konamic_dum_006 === enuproc ){ /////////// // [202][--------]
                                                                 // [202][--------]
                    F_KONAMIC_H3X_H3Y_TOG(2,1);    //:@C___R@:// // [202][--------]
                }else                                            // [202][--------]
                if( c_konamic_dum_007 === enuproc ){ /////////// // [202][--------]
                                                                 // [202][--------]
                    F_KONAMIC_H3X_H3Y_TOG(0,0);    //:@T___L@:// // [202][--------]
                }else                                            // [202][--------]
                if( c_konamic_dum_008 === enuproc ){ /////////// // [202][--------]
                                                                 // [202][--------]
                    F_KONAMIC_H3X_H3Y_TOG(1,0);    //:@T___M@:// // [202][--------]
                }else                                            // [202][--------]
                if( c_konamic_dum_009 === enuproc ){ /////////// // [202][--------]
                                                                 // [202][--------]
                    F_KONAMIC_H3X_H3Y_TOG(2,0);    //:@T___R@:// // [202][--------]
                                                                 // [202][--------]
                }/////////////////////////////////////////////// // [202][--------]
                      //:--------------------------------://     // [202][--------]
...
//|--|--|--|--|--|--|--|--|--|SUBS|--|--|--|--|--|--|--|--|--|// // [---][???]
    ...
    PRIVATE_F_KEYMAST_EVT_N10(                                   // [203] put this function up above all of the        !!!
        ...
        if( i_evt_key.keyCode >=  96  //:numpad0://              // [203][MOV][105][---]
        &&  i_evt_key.keyCode <= 105  //:numpad9://              // [203][MOV][105][---]
        ){                                                       // [203][MOV][105][---]
            let     k_c =( i_evt_key.keyCode );                  // [203][MOV][131][---]
            o_n10=( k_c - 96 );                                  // [203][MAE][131][105]
            LOG( "[EVT_N10:NUMPAD_KEYCODE]:" , k_c   );          // [203][MAE][131][---]
            LOG( "[EVT_N10:NUMPAD_PAD_NUM]:" , o_n10 );          // [203][MAE][131][---]
        };;                                                      // [203][MOV][105][---]
                                                                 // [-------------][---]
        return( o_n10 );                                         // [203][--------][---]
                                                                 // [203]
    ...
    PRIVATE_F_KEYMAST_DOW_EDI(                                   // [104]
        ...
        //:#_KONAMI_BRAND_MAXI_PADS_#:[203]:-----------------:// // [--------]
            ...
            var pad_num=( 0-1 );                                 // [---][105]
            pad_num =( F_KEYMAST_EVT_N10( i_evt_key ) );         // [203][---]
            if( pad_num >= 0 ){                                  // [203][---]
