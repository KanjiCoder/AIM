...
//:                                                          :// // [102]
//: SOURCE__CODE : github.com/KanjiCoder/AIM_114             :// // [114][113][112][111][110][109][108][107][106][105][104][103][102][100][099][098][097][096][095][094][093][092][091][090][089][088][087][086][085][084][083][082][081][080][079]                               
...
/** ******************************************************** *** // [102]
    ...
    ASERVER [C:01] [D:04] : Server Side Functions Only           // [102]
    DABITCH [C:02] [D:05] : Database Access Functions Only       // [102]
    EDIGAME [C:08] [D:06] : Editor State + Game State            // [102]
    KEYMAST [C:03] [D:07] : Keyboard Listeners                   // [102]
    SERGAME [C:06] [D:08] : HIGH_LEVEL_GAME_CODE - Server Side   // [102]
    CLIGAME [C:07] [D:09] : HIGH_LEVEL_GAME_CODE - Client Side   // [102]
                                                                 // [102]
*** ******************************************************** **/ // [102]
//:=======================================:SYSTEM_INDEX:[102]://
    ...
    const F_ARR_I32 = function PRIVATE_F_ARR_I32(                // [114]
        ...
        if( len !=( i_len + 1 ) ){                               // [114]
            ...
            for( dex = 0 ; dex <=( i_len-1 ) ; dex ++ ){         // [114]
                ...
                if(  arg < 0   ){ ERR("[NEG_I32]"); };           // [114]
                if(!( arg>=0 ) ){ ERR("[WTF_I32]"); };           // [114]
                o_arr[ dex ] = ( arg );                          // [114]
            };;                                                  // [114]
        };;                                                      // [114]
...
if( /** __CAMERAH__ **/ notnode ){                              // [108]
    ...
    var d_camerah_org = F_ARR_U32( 4 , 0 , 0 , 0 , 0 );         // [111]
                                                                // [---]
...
if( /** __KEYMAST__ **/ notnode ){                              // [102]
    ...
    var d_keymast_ark_dvy = F_CAR_I32(  4                       // [114]
        ...
        , ( 0 + 1 )     //: @ark_dow@ : Arrow Key Down   ://    // [114]
                                                                ...
                                                                // [114]
    ASS((0-1)===d_keymast_ark_dvx[   c_keymast_ark_lef   ]);    // [114]
    ASS(( 0 )===d_keymast_ark_dvx[   c_keymast_ark_upp   ]);    // [114]
    ASS((0+1)===d_keymast_ark_dvx[   c_keymast_ark_rig   ]);    // [114]
    ASS(( 0 )===d_keymast_ark_dvx[   c_keymast_ark_dow   ]);    // [114]
                                                                // [114]
    ASS(( 0 )===d_keymast_ark_dvy[   c_keymast_ark_lef   ]);    // [114]
    ASS((0-1)===d_keymast_ark_dvy[   c_keymast_ark_upp   ]);    // [114]
    ASS(( 0 )===d_keymast_ark_dvy[   c_keymast_ark_rig   ]);    // [114]
    ASS((0+1)===d_keymast_ark_dvy[   c_keymast_ark_dow   ]);    // [114]
                                                                // [---]
};;                                                             // [102]
    ...
    PRIVATE_F_ARTGIRL_RPL( //:Render Pipeline Load @RPL@ ://    // [068] 
        ...
        //:LIKE_AND_SUBSCRIBE_YOU_FREELOADER:[082]:------://    //      [082]
            ...
            if( NIL( wgl ) ){                                   //      [082]
                ...
                d_vp1_loc = GUL(  act_pid , "d_vp1" );          // [091]
                                                                // [091]
                wgl.uniform1ui(  d_tik_loc , d_tik   );         // [091]
    ...
    PRIVATE_F_ARTGIRL_TIK(                                      //      [063] 
        ...
        //:update_frag_shader_uniforms:[086]-------------://    // [086]
            ...
            //:[#NOW_OPTIMIZED#][#PMOITROAE#]://                // [091][086]
                                                                // [091]
            a_g.wgl.uniform1ui(  d_tik_loc , d_tik );           // [091]
            a_g.wgl.uniform4uiv( d_vpc_loc , d_vpc );           // [091]
            a_g.wgl.uniform4uiv( d_vp0_loc , d_vp0 );           // [091]
            a_g.wgl.uniform4uiv( d_vp1_loc , d_vp1 );           // [091]
                                                                // [---]
...
//|--|--|--|--|--|--|--|--|--|SUBS|--|--|--|--|--|--|--|--|--|// // [109]
    ...
    const   F_CAMERAH_START       = "[FIX:CAMERAH_HOSTART]" ;    // [109]
    const   F_CAMERAH_BEGIN       = "[FIX:CAMERAH_HOSTART]" ;    // [109]
    const   F_CAMERAH_TELEPORT    = "[FIX:CAMERAH_HOSTART]" ;    // [109]
    const   F_CAMERAH_HOTEL_START = "[FIX:CAMERAH_HOSTART]" ;    // [109]
                                                                 // [109]
    ...
    PRIVATE_F_CAMERAH_VP1(                                       // [109]
        ...
        //:Camera_Snapping:[111]:------------------------://     // [111]
            ...
            if( d_camerah.camsnap >= 1 ){                        // [111]
                ...
                ERR("[ONONONONONONO]");                          // [111]
                                                                 ...
                                                                 // [111]
            d_camerah_org[ x_0 ]=( a_x + 0 );                    // [111]
            d_camerah_org[ y_0 ]=( a_y + 0 );                    // [111]
            d_camerah_org[ x_1 ]=( a_x + 1 );                    // [111]
            d_camerah_org[ y_1 ]=( a_y + 1 );                    // [111]
                                                                 // [111]
        //:------------------------:Camera_Snapping:[111]://     // [111]
        //:- - - - - - - - - - - -- - - - - - - - - - - -://     // [---]
        //:Put_It_All_Together:[112]:--------------------://     // [112]
            ...
            let h_h =Math.floor( dun_hig / 2 );  //:@h_h@://     // [112]
                ...
                //:--------------------------------------://     // [112]
                                                                 // [112]
            d_vp1[ x_0 ] =( d_camerah_org[ x_0 ] - h_w+1 );      // [112]
            d_vp1[ y_0 ] =( d_camerah_org[ y_0 ] - h_h+1 );      // [112]
            d_vp1[ x_1 ] =( d_camerah_org[ x_1 ] + h_w-1 );      // [112]
            d_vp1[ y_1 ] =( d_camerah_org[ y_1 ] + h_h-1 );      // [112]
                                                                 // [112]
        //:--------------------:Put_It_All_Together:[112]://     // [112]
        ...
        {                                                        // [112]
            ...
            let  duo =( 0-666 ); //: @duo@ : @D_U@Overflo://     // [112]
                                                                 // [112]
            if( d_vp1[ x_0 ] < b_0                               // [112]
            &&  d_vp1[ x_1 ] > b_1                               // [112]
            ){  ERR("[IM_FUCKING_POSSIBLE:AXIS_X]"); };          // [112]
            if( d_vp1[ y_0 ] < b_0                               // [112]
            &&  d_vp1[ y_1 ] > b_1                               // [112]
            ){  ERR("[IM_FUCKING_POSSIBLE:AXIS_Y]"); };          // [112]
                                                                 // [112]
            //:VP1_SHIFT:LEF_RIG:[112]:------------------://     // [112]
                                                                 // [112]
                if( d_vp1[ x_0 ] < b_0 ){      //:OOB_LEF://     // [112]
                                                                 // [112]
                    duo =( b_0 - d_vp1[ x_0 ] );                 // [112]
                    ( d_vp1[ x_0 ] )+=(  duo  );                 // [112]
                    ( d_vp1[ x_1 ] )+=(  duo  );                 // [112]
                }else                                            // [112]
                if( d_vp1[ x_1 ] > b_1 ){      //:OOB_RIG://     // [112]
                                                                 // [112]
                    duo =( d_vp1[ x_1 ] - b_1 );                 // [112]
                    ( d_vp1[ x_0 ] )-=(  duo  );                 // [112]
                    ( d_vp1[ x_1 ] )-=(  duo  );                 // [112]
                }else{                                           // [112]
            ...
            //:VP1_SHIFT:TOP_BOT:[112]:------------------://     // [112]
                                                                 // [112]
                if( d_vp1[ y_0 ] < b_0 ){      //:OOB_TOP://     // [112]
                                                                 // [112]
                    duo =( b_0 - d_vp1[ y_0 ] );                 // [112]
                    ( d_vp1[ y_0 ] )+=(  duo  );                 // [112]
                    ( d_vp1[ y_1 ] )+=(  duo  );                 // [112]
                }else                                            // [112]
                if( d_vp1[ y_1 ] > b_1 ){      //:OOB_BOT://     // [112]
                                                                 // [112]
                    duo =( d_vp1[ y_1 ] - b_1 );                 // [112]
                    ( d_vp1[ y_0 ] )-=(  duo  );                 // [112]
                    ( d_vp1[ y_1 ] )-=(  duo  );                 // [112]
                }else{                                           // [112]
    ...
    PRIVATE_F_KEYMAST_DOW_EDI(                                  // [104]
        ...
        if( oh_my_god_its_the_arrow_keys ){                     // [114]
            ...
            let dvy = d_keymast_ark_dvy[ ark_num ];             // [114]
                                                                // [114]
            console.log( "[dvx,dvy]" , [dvx,dvy] );             // [114]
            VITALDO( "[Call_Panning_Code_Here]" );              // [114]
                                                                // [114]
        }else                                                   // [114]
        if( oh_my_god_its_the_numpad ){                         // [105]
                                                                // [105]
            if( pad_num >= 1 && pad_num <= 9 ){                 // [105]
                                                                // [105]
                ...
                ,   2 , 0  //:[ T_R ]( 9 )://                   // [105]
                                                                ...
                                                                // [105]
                let c_x =( cel[ (pad_num*2)+0 ] );              // [105]
                let c_y =( cel[ (pad_num*2)+1 ] );              // [105]
                                                                // [105]
...
/** ******************************************************** ***
          ...
          :---:--------------------------------------------:      // [114]
    [114] : 1 :  Added Arrow Key Detection To KEYMAST ,    :      // [114]
          :---:--------------------------------------------:      // [114]
          :   : 1.1 :  ARR_I32 , CAR_I32                   :      // [114]
          :   : 1.2 :  c_keymast_ark_[lef|rig|upp|dow]     :      // [114]
          :   : 1.3 :  ark_dvx , ark_dvy lookup tables     :      // [114]
          :   : 1.4 :  oh_my_god_its_the_arrow_keys        :      // [114]
          :---:--------------------------------------------:      // [114]
          : # : __NOT__YET__ : ArrowKey ==> PanFunc( )     :      // [114]
          :---:--------------------------------------------:      // [114]
