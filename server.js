...
//|--|--|--|--|--|--|--|--|--|SUBS|--|--|--|--|--|--|--|--|--|// // [156]
    ...
    ,   i_u32        //:<--Raw_U32_Tile_Value                :// //      [161]
        ...
        const lat_lev =(   5*lat   ); //:Lateral_Span_Level  :// // [162]
                                                                 // [162]
        ...
        ||  ( i_gty < 0 ) || ( i_gty > gmi )                     // [162]
            ...
            //:::::::::::::::::::::::::::::::::::::::::::://     // [162]
                                                                 ...
                                                                 // [162]
            var h3x = ( Math.floor( i_gtx / lat_lev ) );         // [162]
            var h3y = ( Math.floor( i_gty / lat_lev ) );         // [162]
            var hi9 = ( h3x + ( h3y * 3 ) );                     // [162]
            var tlx = ( i_gtx - (     h3x * lat_lev ) );         // [162]
            var tly = ( i_gty - (     h3y * lat_lev ) );         // [162]
                                                                 // [162]
            ASS( h3x >= 0 && h3x <= (  3-1) , "[E_P:h3x]" );     // [162]
            ASS( h3y >= 0 && h3y <= (  3-1) , "[E_P:h3y]" );     // [162]
            ASS( hi9 >= 0 && hi9 <= (  9-1) , "[E_P:hi9]" );     // [162]
            ASS( tlx >= 0 && tlx <= ( 64-1) , "[E_P:tlx]" );     // [162]
            ASS( tly >= 0 && tly <= ( 64-1) , "[E_P:tly]" );     // [162]
        ...
        };; //:ENDOF[ EDI_PUT_U32 ]:::::::::::::::::::::::::::// // [162]
    };;     //:ENDOF[ EDI_PUT_U32 ]:::::::::::::::::::::::::::// //      [161]
    ...
    ,   i_u32        //:<--Raw_U32_Tile_Value                :// //      [161]
        ...
        ||  ( i_gty < 0 ) || ( i_gty > gmi )                     // [162]
            ...
            ASS( tlx >= 0 && tlx <= ( 64-1) , "[E_G:tlx]" );     // [162]
            ASS( tly >= 0 && tly <= ( 64-1) , "[E_G:tly]" );     // [162]
