...
//:TOP_LEVEL_CONSTANT_MACROS:[085]:==========================:// // [085]
    ...
    {                                                            // [191]
        let M_F = Math.floor ;                                   // [191]
                                                                 // [191]
        const c_dui_max =( 0x124912 );                           // [191]
        const c_dui_1_3 =(  0x6185B );                           // [191]
        const c_dui_2_3 =(  0xC30B6 );                           // [191]
        const c_dui_3_3 =( 0x124911 );                           // [191]
                                                                 // [191]
        ...
        const c_dui_fad =( c_dui_3_3 ); //:F_G ==> SMALL  ://    // [191]
                                                                 // [191]
        ASS( c_dui_max === M_F( c_dut     / 7 ) , "[IMAX]" );    // [191]
        ASS( c_dui_1_3 === M_F( c_dui_max / 3 ) , "[I_13]" );    // [191]
    ...
    #define inn_u_gty "[USE:u32_gty::::::::]"                    //      [175]
        ...
        //- lat_lev = d_te7_dun[  any_te7  ]; <-- FUCK.  -//     // [177][176]
            ...
            //:#_OOB_INSET_DEL_#:[191]:----------------------:// // [191]
                                                                 // [191]
                //:WE_WILL_DO_THIS_IN_NEXT_VIDEO: #1_9_2 ://     // [191]
                                                                 // [191]
            //:----------------------:#_OOB_INSET_DEL_#:[191]:// // [191]
    ...
    ,   i_u32        //:<--Raw_U32_Tile_Value                :// // [185][MOV][161]
        ...
        if( o_k >= 1 ){                                          // [185][MOV][162]
            ...
            //: #_TILE_PUT_BIT_UN_PACK_DIAGRAM_#  @BITLOGIC@ :// // [185][MOV][168]
                                                                 // [185][MOV][168]
            p2k[ dpc+0 ]=( i_u32 >>> 24 )&(0xFF) ; //:@RBS_R@:// // [185][MOV][168]
            p2k[ dpc+1 ]=( i_u32 >>> 16 )&(0xFF) ; //:@RBS_G@:// // [185][MOV][168]
            p2k[ dpc+2 ]=( i_u32 >>>  8 )&(0xFF) ; //:@RBS_B@:// // [185][MOV][168]
            p2k[ dpc+3 ]=( i_u32 >>>  0 )&(0xFF) ; //:@RBS_A@:// // [185][MOV][168]
                                                                 // [185][MOV][168]
            //:--------------:_P2K_section_has_INVERSE_:[168]:// // [185][MOV][168]
                                                                 // [185][MOV][---]
        };; //:[ ? o_k ? ]::::::::::::::::::::::::::::::::::::// // [185][MOV][162]
...
/** ******************************************************** ***         
    ...
    [191] : 1 : Added constants to tell us how much we           // [191]
          ...
          : 2 : Added CPU-SIDE and GPU-SIDE lookup tables        // [191]
          :   : that convert :                                   // [191]
          :   : ( la3 )==>( inset in discrete units )            // [191]
