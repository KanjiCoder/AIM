...
//: __SEXYCAM__ V_V_V_V_V_V_V_V_V_V_V_V_V_V_V_V_V_V_V_V_V_V_V:// // [125]
    ...
    const c_sexycam_act_zomext =( 1 ); //:Zoom Extents   ://     // [135]
    const c_sexycam_act_cirdef =( 2 ); //:cir_cum:DEFAULT://     // [135]
    const c_sexycam_act_cirnex =( 3 ); //:cir_cum:NEXT   ://     // [135]
...
if( /** __SEXYCAM__ **/ notnode ){                               // [125]
    ...
    //:::::::::::::::::::::::::::::::::::::::::::::::::::://     // [135]
    ,   npa_000 : c_sexycam_act_zomext //:Zoom Extents   ://     // [135]
    ,   npa_dot : c_sexycam_act_cirdef //:cir_cum:NEXT   ://     // [135]
    ,   npa_ent : c_sexycam_act_cirnex //:cir_cum:DEFAULT://     // [135]
    //:::::::::::::::::::::::::::::::::::::::::::::::::::://     // [135]
...
//|--|--|--|--|--|--|--|--|--|SUBS|--|--|--|--|--|--|--|--|--|// // [125]
    ...
    PRIVATE_F_SEXYCAM_ZOOMEXT(                                   // [135]
        ...
        //: A bit hackish: The first keypress of                 // [135]
        //: a given numpad number causes us to                   // [135]
        //: use the largest zero-basis,                          // [135]
        //: effectively doing a zoom-extents.                    // [135]
        //: Also must set to netural zoom of zero.               // [135]
                                                                 // [135]
        ////// d_camerah.camzoom =(0.0); //:NeutralZoom://       // [135]
        ////// d_sexycam.but_not =( 1 );                         // [135]
        ////// d_sexycam_dir     =( 1 );                         // [135]
        ////// F_SEXYCAM_TIK(); //:UPDATE_SEXYCAM://             // [135]
                                                                 // [135]
        MSG( "[TODO:ZOOMEXT]" );                                 // [135]
                                                                 // [135]
    };;                                                          // [135]
    ...
    PRIVATE_F_SEXYCAM_NEXTEXT(                                   // [135]
        ...
        if(!( (i_pad_num >= 0 )&&(i_pad_num <= 9) ) ){           // [135]
            ...
            //:#_SEXYCAM_SETS_ZEROBASIS_#:[129]:---------://     // [129]
                ...
                d_camerah_dir =(        1    );//:@REDUNDANT@:// // [135][130]
...
/** ******************************************************** ***
    ...
    @npa_ent@ : Num_Pad_Action : Key Enter                       // [135]
                                                                 // [135]
    @zomext@  : Zoom Extents                                     // [135]
    @cirdef@  : CIR_cum DEFault                                  // [135]
    @cirnex@  : CIR_cum NEXT                                     // [135]
