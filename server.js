...
//|--|--|--|--|--|--|--|--|--|SUBS|--|--|--|--|--|--|--|--|--|// // [156]
    ...
    ,   i_tly       //: Tile Local Y (LevelPackLocal)    ://     //      [162]
        ...
        var mmy = d_hi9_mmy[ hi9 ]; //:MasterMemoryCell.Y://     // [166]
                                                                 // [166]
        var dia     = d_te7_dia[ i_te7 ];                        // [166]
        var lat     = d_te7_lat[ i_te7 ];                        // [166]
        var lmx     = d_la3_lmx[ i_la3 ];                        // [166]
        var lmy     = d_la3_lmy[ i_la3 ];                        // [166]
                                                                 // [166]
        var r5x = i_tlx - Math.floor( i_tlx / lat );             // [166]
        var r5y = i_tly - Math.floor( i_tly / lat );             // [166]
