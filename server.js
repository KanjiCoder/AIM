...
//:TOP_LEVEL_LOOKUP_TABLES:[128]:============================://
    ...
    ASS( 9 == d_hi9_mmy.length , "[HI9_MMY.LEN]" );              // [163]
        ...
        //:SEE[ _AIM_MASTER_MEMORY_LAYOUT_ ]://                  // [163]
                                                                 // [163]
        ASS( c_mm0 === d_hi9_mmx[0]+(3*d_hi9_mmy[0]) ,"[M_0]" ); // [163]
        ASS( c_mm1 === d_hi9_mmx[1]+(3*d_hi9_mmy[1]) ,"[M_1]" ); // [163]
        ASS( c_mm2 === d_hi9_mmx[2]+(3*d_hi9_mmy[2]) ,"[M_2]" ); // [163]
                                                                 // [163]
        if(  c_mm4 !== d_hi9_mmx[3]+(3*d_hi9_mmy[3]) ){          // [163]
            let dex  = d_hi9_mmx[3]+(3*d_hi9_mmy[3]);            // [163]
                                                                 // [163]
        ...
        ASS( c_mm5 === d_hi9_mmx[4]+(3*d_hi9_mmy[4]) ,"[M_5]" ); // [163]
        ASS( c_mm6 === d_hi9_mmx[5]+(3*d_hi9_mmy[5]) ,"[M_6]" ); // [163]
                                                                 // [163]
        ASS( c_mm8 === d_hi9_mmx[6]+(3*d_hi9_mmy[6]) ,"[M_8]" ); // [163]
        ASS( c_mm9 === d_hi9_mmx[7]+(3*d_hi9_mmy[7]) ,"[M_9]" ); // [163]
        ASS( c_mma === d_hi9_mmx[8]+(3*d_hi9_mmy[8]) ,"[M_A]" ); // [163]
                                                                 // [163]
                                                                 // [163]
    {                                                            // [163]
                                                                 // [163]
...
//: ASS_TUP( [0,0] , [d_g25_r4x[2],d_g25_r4y[2] , "[T_2]" ); < < < < < < < < < NOTICE_ME_SENPAI : TODO : Assert Tuple Function To Check Our Work [163]
...
//|--|--|--|--|--|--|--|--|--|SUBS|--|--|--|--|--|--|--|--|--|// // [156]
    ...
    ,   i_tly       //: Tile Local Y (LevelPackLocal)    ://     // [162]
        ...
        var o_dpc =(0-666); //:@o_dpc@:OutputDataPixelCom://     // [162]
                                                                 // [---]
        //# We will write this in video #1_6_5# Probably. #//    // [163]
                                                                 // [---]
        return( o_dpc );                                         // [162]
    };;                                                          // [162]
                                                                 // [162]
...
/** ******************************************************** ***
    ...
    [163] : A lot of lookup tables were added so that we         // [163]
          : hopefully have all the lookup tables needed for      // [163]
          : [ F _ TILEBOI _ HI9 _ TE7 _ LA3 _ TLX _ TLY _ DPC ]  // [163]
          :                                                      // [163]
          : Also added supporting symbolic constants to          // [163]
          : help create afformentioned lookup tables.            // [163]
