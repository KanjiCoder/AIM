...
//:                                                          :// // [102]
//: SOURCE__CODE : github.com/KanjiCoder/AIM_159             :// // [159][158][157][156][155][154][153][152][151][150][148][147][146][145][144][143][142][141][140][139][138][137][136][135][134][133][132][131][130][129][128][127][126][125][124][122][121][120][119][117][116][115][113][112][111][110][109][108][107][106][105][104][103][102][100][099][098][097][096][095][094][093][092][091][090][089][088][087][086][085][084][083][082][081][080][079]                               
...
//|--|--|--|--|--|--|--|--|--|SUBS|--|--|--|--|--|--|--|--|--|// // [142]
    ...
    PRIVATE_F_MOUMAST_MOV(                                       // [143]
        ...
        d_edigame_edi.mou_p_y =( mov_p_y );                      // [144]
                                                                 ...
                                                                 //      [156]
        //:::::::::::::::::::::::::::::::::::::::://             // [157]
        //: @REFACTOR_DONE@  :  d_m_x ==> d_dmx  ://             // [157][152]
        //: @REFACTOR_DONE@  :  d_m_y ==> d_dmy  ://             // [157][152]
        //: @REFACTOR_DONE@  :  d_t_x ==> d_gtx  ://             // [157][152]
        //: @REFACTOR_DONE@  :  d_t_y ==> d_gty  ://             // [157][152]
        //:::::::::::::::::::::::::::::::::::::::://             // [157]

        let te7 =( d_edigame_edi.edi_te7 );                      //      [153]
                                                                 //      [---]
        d_dmx =( F_MOUMAST_P_X_DUX( mov_p_x ) );                 // [157][145]
        d_dmy =( F_MOUMAST_P_Y_DUY( mov_p_y ) );                 // [157][145]
                                                                 //      [---]
        d_gtx =( F_EDIGAME_TE7_DUX_GTX( te7 , d_dmx ) );         // [157][153][152]
        d_gty =( F_EDIGAME_TE7_DUY_GTY( te7 , d_dmy ) );         // [157][153][152]
                                                                 //      [---]
    };;                                                          //      [143]
                                                                 //      [143]
...
/** ******************************************************** ***
    ...
    [159] : [_VIDEO_159_TILE_DATA_LAYOUT_EXPLAINED_]             // [159]
          :      :                                               // [159]
          : NEXT : Add constants that appear in COMMENT          // [159]
          :      : diagrams to the CODE sections.                // [159]
