...
(c_artgirl_wgl_tag+`                                             // [074]   
    ...
    out vec4  out_f_c ; //: @out_f_c@ ://                        // [---][074]
                                                                 // [175]
    UV3 GET_UV3_P2K( void ){ /// #_WHY_UV3_P2K_# /////////////// // [175]
                                                                 // [175]
        UV3 uv3_p2k ;                                            // [175]
                                                                 // [175]
        uv3_p2k.x =( u_0 ); //:GEOM_TILE://                      // [175]
        uv3_p2k.y =( u_0 ); //:BOMB_TILE://                      // [175]
        uv3_p2k.z =( u_0 ); //:FADA_TILE://                      // [175]
                                                                 // [175]
        return( uv3_p2k );                                       // [175]
                                                                 // [175]
    } ////////////////////////////////////////////////////////// // [175]
...
g25_set ||10 |11 |12 |13 |14 ||  "grid cell indexes" and       :   [163][087]
  ...
  -=-   +---------------------+  g25 : GridIndexes : 0-to-24   :   [163][087]
    ...
    #_WHY_UV3_P2K_# :-----------------------------------------+  // [175]
                                                              |  // [175]
        In 99% of cases in our shader, we want to             |  // [175]
        get ALL 3 TILE LAYERS that exist for a given          |  // [175]
        fragment.                                             |  // [175]
                                                              |  // [175]
        A lot of those calculations are going to be           |  // [175]
        the same for all 3 layers, so we should AVOID         |  // [175]
        RECALCULATION FOR EFFICIENCY.                         |  // [175]
                                                              |  // [175]
        The[ GET_UV3_P2K ]returning a uvec3 will allow        |  // [175]
        us to make 1 function call per sample coord           |  // [175]
        instead of 3. I call that a good deal.                |  // [175]
                                                              |  // [175]
        Mike Acton says to optimize for the most common       |  // [175]
        case. Be proud of me Mike Acton , who doesn't         |  // [175]
        know I exist. -KanjiCoder                             |  // [175]
                                                              |  // [175]
    +---------------------------------------------------------+  // [175]
