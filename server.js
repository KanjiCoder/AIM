...
//:                                                          :// // [102]
//: SOURCE__CODE : github.com/KanjiCoder/AIM_156             :// // [156][155][154][153][152][151][150][148][147][146][145][144][143][142][141][140][139][138][137][136][135][134][133][132][131][130][129][128][127][126][125][124][122][121][120][119][117][116][115][113][112][111][110][109][108][107][106][105][104][103][102][100][099][098][097][096][095][094][093][092][091][090][089][088][087][086][085][084][083][082][081][080][079]                               
...
/** ******************************************************** *** // [102]
    ...
    PIX2048 [C:13] [D:07] : Data Storage For Game.               // [156]
    TILEBOI [C:12] [D:08] : Tile GET,PUT,SAVE,LOAD Stuff         // [156]
    EDIGAME [C:08] [D:09] : Editor State + Game State            // [102]
    KEYMAST [C:03] [D:10] : Keyboard Listeners                   // [102]
    MOUMAST [C:11] [D:11] : Mouse Master (Mouse Listeners)       // [142]
    SERGAME [C:06] [D:12] : HIGH_LEVEL_GAME_CODE - Server Side   // [102]
    CLIGAME [C:07] [D:13] : HIGH_LEVEL_GAME_CODE - Client Side   // [102]
                                                                 // [102]
*** ******************************************************** **/ // [102]
//:=======================================:SYSTEM_INDEX:[102]://
...
//:TOP_LEVEL_VARIABLES:[088]:================================://    [---]
    ...
    var d_m_x     =( c_dum /** OUT_OF_BOUNDS_BY_ONE **/ );       // [141]
    var d_m_y     =( c_dum /** OUT_OF_BOUNDS_BY_ONE **/ );       // [141]
    var d_t_x     =( c_tmi_000 + 1 );  //:GLOBAL_TILE_X://       // [150]
    var d_t_y     =( c_tmi_000 + 1 );  //:GLOBAL_TILE_Y://       // [150]
    ...
    var     d_m_x_loc =( 0- 6 ); //:LOC[ d_m_x ]In_Shader://     // [141]
    var     d_m_y_loc =( 0- 7 ); //:LOC[ d_m_t ]In_Shader://     // [141]
    var     d_t_x_loc =( 0- 8 ); //:LOC[ d_t_x ]In_Shader://     // [150]
    var     d_t_y_loc =( 0- 9 ); //:LOC[ d_t_y ]In_Shader://     // [150]
...
//: __PIX2048__ V_V_V_V_V_V_V_V_V_V_V_V_V_V_V_V_V_V_V_V_V_V_V:// // [156]

    /** NOTHING_HERE_YET **/                                     // [156]

//: __TILEBOI__ V_V_V_V_V_V_V_V_V_V_V_V_V_V_V_V_V_V_V_V_V_V_V:// // [156]
...
(c_artgirl_wgl_tag+`                                            // [074]   
    ...
    UNI U32 d_m_x     ;  //: Discrete_Mousepos_X         ://    //      [141]
    UNI U32 d_m_y     ;  //: Discrete_Mousepos_Y         ://    //      [141]
    UNI U32 d_t_x     ;  //: Global_Tile_X               ://    // [155]
    UNI U32 d_t_y     ;  //: Global_Tile_Y               ://    // [155]
    ...
    //: u_dup =( DiscreteUnitSelection )/( NumPixelsOnScreen ); //      [097]
        ...
        //:use_the_sample_point:[099]:-----------------------://// [099]
            ...
            //:cursor_dot:[147]:-------------------------://    // [---]
            if( 1 != 1                                          //      [147]
            || abs( I32( u_dsc.x ) - I32( d_m_x ) ) < 256       // [149][147]
            || abs( I32( u_dsc.y ) - I32( d_m_y ) ) < 256       // [149][147]
            ){                                                  //      [147]
                out_f_c.r =( 1.0             );                 //      [147]
...
if( /** __PIX2048__ **/ notnode ){                               // [156]
    /** __PIX0152__ <-- Not A Namespace **/                      // [156]
                                                                 // [156]
    var d_pix2048 = new Uint8Array( 4 * 2048 * 2048 );           // [156]
...
//|--|--|--|--|--|--|--|--|--|SUBS|--|--|--|--|--|--|--|--|--|//
    ...
    PRIVATE_F_ARTGIRL_UNI_PUT(                                  // [121]
        ...
        wgl.uniform1ui(      d_m_x_loc , d_m_x     );           //      [141]
        wgl.uniform1ui(      d_m_y_loc , d_m_y     );           //      [141]
        wgl.uniform1ui(      d_t_x_loc , d_t_x     );           // [150]
        wgl.uniform1ui(      d_t_y_loc , d_t_y     );           // [150]
    ...
    PRIVATE_F_ARTGIRL_RPL( //:Render Pipeline Load @RPL@ ://    // [068] 
        ...
        //:LIKE_AND_SUBSCRIBE_YOU_FREELOADER:[082]:------://    //      [082]
            ...
            if( NIL( wgl ) ){                                   //      [082]
                ...
                d_m_x_loc     = GUL(  pid , "d_m_x"     );      //      [141]
                d_m_y_loc     = GUL(  pid , "d_m_y"     );      //      [141]
                d_t_x_loc     = GUL(  pid , "d_t_x"     );      // [150]
                d_t_y_loc     = GUL(  pid , "d_t_y"     );      // [150]
...
//|                                               [ @$$$$$@ ]|// // [???]
//|02|02|02|02|02|02|02|02|02|SUBS|02|02|02|02|02|02|02|02|02|// // [???]
//|13|13|13|13|13|13|13|13|13|SUBS|13|13|13|13|13|13|13|13|13|// // [156]
//|[ @$$$$$@ ]                                               |// // [156]
//|__PIX2048__ VVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVV |// // [156]
//|[ @$$$$$@ ]                                               |// // [156]
//|--|--|--|--|--|--|--|--|--|SUBS|--|--|--|--|--|--|--|--|--|// // [156]

    /** PIX2048 functions go here **/                            // [156]
...
//|                                               [ @$$$$$@ ]|// // [156]
//|13|13|13|13|13|13|13|13|13|SUBS|13|13|13|13|13|13|13|13|13|// // [156]
//|12|12|12|12|12|12|12|12|12|SUBS|12|12|12|12|12|12|12|12|12|// // [156]
//|[ @$$$$$@ ]                                               |// // [156]
//|__TILEBOI__ VVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVV |// // [156]
//|[ @$$$$$@ ]                                               |// // [156]
//|--|--|--|--|--|--|--|--|--|SUBS|--|--|--|--|--|--|--|--|--|// // [156]
...
//|--|--|--|--|--|--|--|--|--|SUBS|--|--|--|--|--|--|--|--|--|// // [142]
    ...
    PRIVATE_F_MOUMAST_MOV(                                       // [143]
        ...
        let te7 =( d_edigame_edi.edi_te7 );                      // [153]
                                                                 // [---]
        d_m_x =( F_MOUMAST_P_X_DUX( mov_p_x ) );                 // [145]
        d_m_y =( F_MOUMAST_P_Y_DUY( mov_p_y ) );                 // [145]
                                                                 // [---]
        d_t_x =( F_EDIGAME_TE7_DUX_GTX( te7 , d_m_x ) );         // [153][152]
        d_t_y =( F_EDIGAME_TE7_DUY_GTY( te7 , d_m_y ) );         // [153][152]
                                                                 // [---]
    };;                                                          // [143]
                                                                 // [143]
