...
:::----------------------------------------------------------:::
    Git Repo With All Source Code ::::::::::::::::::::::::::::::
        ...
        github.com/KanjiCoder/AIM_094  <<< THIS_VIDEO¯S_CODE    // [094][093][092][091][090][089][088][087][086][085][084][083][082][081][080][079]                               
...
(c_artgirl_wgl_tag+`                                            // [074]   
    ...
    void main(){  //////////////////////////////////////////////// [074]
        ...
        U32  u_fcx = (       u_0   + U32( f_raw_fcx - 0.5 ));   // [089]
        U32  u_fcy = (d_vpc[ y_1 ] - U32( f_raw_fcy - 0.5 ));   // [089]
                                                                // [089]
        out_f_c = vec4(                                         // [089]
            F_NOR_FCX  //:#_NOR_CURRENTLY_DIVISION_BY_ZERO_# ://// [089]
        ,   F_NOR_FCY  //:#_NOR_CURRENTLY_DIVISION_BY_ZERO_# ://// [089]
        ,   0.0                                                 // [089]
        ,   1.0                                                 // [089]
        );;                                                     // [089]
