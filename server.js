...
//:                                                          :// // [102]
//: SOURCE__CODE : github.com/KanjiCoder/AIM_155             :// // [155][154][153][152][151][150][148][147][146][145][144][143][142][141][140][139][138][137][136][135][134][133][132][131][130][129][128][127][126][125][124][122][121][120][119][117][116][115][113][112][111][110][109][108][107][106][105][104][103][102][100][099][098][097][096][095][094][093][092][091][090][089][088][087][086][085][084][083][082][081][080][079]                               
...
/** ******************************************************** *** // [102]
    ...
    MOUMAST [C:11] [D:09] : Mouse Master (Mouse Listeners)       // [142]
    SERGAME [C:06] [D:10] : HIGH_LEVEL_GAME_CODE - Server Side   // [102]
    CLIGAME [C:07] [D:11] : HIGH_LEVEL_GAME_CODE - Client Side   // [102]
                                                                 // [102]
*** ******************************************************** **/ // [102]
//:=======================================:SYSTEM_INDEX:[102]://
...
(c_artgirl_wgl_tag+`                                            // [074]   
    ...
    U32 d_te7_dun[ 7 ]=U32[ 7 ](                                // [155]
        ...
        ${c_du0}    //:----------------------------------://    // [155]
    ,   ${c_du1}    //:                                  ://    // [155]
    ,   ${c_du2}    //:  Your mom was an abacus and      ://    // [155]
    ,   ${c_du3}    //:  your father reeked of           ://    // [155]
        ...
        //:use_the_sample_point:[099]:-----------------------://// [099]
            ...
            //:Active_Tile_Highlight:[155]:--------------://    // [---]
            {
                ...
                &&  d_t_y == gty                                // [155]
                    ...
                    out_f_c.r =( out_f_c.r * 2.0 );             // [155]
                    out_f_c.g =( out_f_c.g * 2.0 );             // [155]
                    out_f_c.b =( out_f_c.b * 2.0 );             // [155]
                };;                                             // [155]
            }
            //:--------------:Active_Tile_Highlight:[155]://    // [---]
            //:cursor_dot:[147]:-------------------------://    // [---]
...
if( /** __EDIGAME__ **/ notnode ){                               // [102]
    ...
    var d_edigame_edi ={ laxcoma:"[HACK]"                        // [103]
        ...
        /** Members when acting as EDITOR **/                    // [103]
                                                                 // [---]
    ,   edi_te7 :( 0 )  //: Tile Size Exponent :---------://     // [151]
                                                                 // [---]
