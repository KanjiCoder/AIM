    ...
    ,   i_v16  //:Tile_VALUE[ #_0_TO_15_ALL_LAYERS_#    ]://     // [170]
        ...
        if( c_lay_fad === i_la3 ){                               // [172]
            ...
            if( d_bug >= 1 ){                                    // [172]
                ...
                let v16 =(( o_u32 >>> (28) )&(0xF00000000));     // [172]
                let tik =(( o_u32 >>> ( 0) )&(0x0FFFFFFFF));     // [172]
                if( tik!=d_tik ){                                // [172]
...
/** ******************************************************** ***
    ...
    [172] : Conversion of tile value and layer to a              // [172]
          : uint32 pixel value that encodes tile value           // [172]
          : AND whatever meta data we need.                      // [172]
          : [ F _ TILEBOI _ LA3 _ V16 _ U32 ]                    // [172]
