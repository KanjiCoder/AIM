...
//:                                                          :// // [102]
//: SOURCE__CODE : github.com/KanjiCoder/AIM_111             :// // [111][110][109][108][107][106][105][104][103][102][100][099][098][097][096][095][094][093][092][091][090][089][088][087][086][085][084][083][082][081][080][079]                               
...
//: __CAMERAH__ V_V_V_V_V_V_V_V_V_V_V_V_V_V_V_V_V_V_V_V_V_V_V:// // [108]
    ...
    const c_camerah_maxunit =( c_dut - 1 - 1 );                  // [111]
    ASS(  c_camerah_maxunit == c_dut -(  2  ));                  // [111]
...
//|--|--|--|--|--|--|--|--|--|SUBS|--|--|--|--|--|--|--|--|--|// // [109]
    ...
    PRIVATE_F_CAMERAH_VP1(                                       // [109]
        ...
        VITALDO( "[!FOR_THE_3RD_TIME_WE_ARE_NOT_FINISHED!]" );   // [111][110][109]
                                                                 // [109]
    };;                                                          // [109]
...
/** ******************************************************** ***
    ...
    #_WHY_MAXUNIT_MINUS_TWO_# :-------------------------------:  // [111]
        ...
        If the camera origin was a POINT :  ( it's __NOT__ )  :  // [111]
                                                              :  // [111]
            THEN: d_camerah_maxunit === ( c_dut - 1 )         :  // [111]
                                                              :  // [111]
        If the camera origin was a 2X2 RECT : ( it __IS___ )  :  // [111]
                                                              :  // [111]
            THEN: d_camerah_maxunit === ( c_dut - 2 )         :  // [111]
                                                              :  // [111]
    :---------------------------------------------------------:  // [111]
                                                                 // [111]
...
/** ******************************************************** ***
    ...
    [111] : Added Camera Snapping Calculations to                // [111]
          : function that uses[ d_camerah ]to alter[ vp1 ].      // [111]
          : ( F_CAMERAH_VP1 )                                    // [111]
