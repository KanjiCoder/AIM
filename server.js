...
(c_artgirl_wgl_tag+`                                            // [074]   
    ...
    //: u_dup =( DiscreteUnitSelection )/( NumPixelsOnScreen ); // [097]
        ...
        //:use_the_sample_point:[099]:-----------------------://// [099]
            ...
            #define e_lef ( c_w[ x_0 ] )                        // [---][122]
            #define e_top ( c_w[ y_0 ] )                        // [---][122]
            #define e_rig ( c_w[ x_1 ] )                        // [---][122]
            #define e_bot ( c_w[ y_1 ] )                        // [---][122]
                                                                // [124]
                ...
                F32 f_bot =( F32(e_bot) / f_c_m );              // [124]
                                                                // [124]
                F32 f_vpc_wid_haf =(                            // [124]
                                                                // [124]
                    F32( d_vpc[ x_1 ] - d_vpc[ x_0 ] + u_1 )    // [124]
                    /                                           // [124]
                    f_2                                         // [124]
                );;                                             // [124]
                F32 f_vpc_hig_haf =(                            // [124]
                                                                // [124]
                    F32( d_vpc[ y_1 ] - d_vpc[ y_0 ] + u_1 )    // [124]
                    /                                           // [124]
                    f_2                                         // [124]
                );;                                             // [124]
                                                                // [124]
                #define f_w_h ( f_vpc_wid_haf )                 // [124]
                #define f_h_h ( f_vpc_hig_haf )                 // [124]
                                                                // [124]
                U32 u_lef =d_vpc[x_0]+U32(f_lef*(f_w_h))-u_1;   // [124]
                U32 u_top =d_vpc[y_0]+U32(f_top*(f_h_h))-u_1;   // [124]
                U32 u_rig =d_vpc[x_1]-U32(f_rig*(f_w_h))+u_1;   // [124]
                U32 u_bot =d_vpc[y_1]-U32(f_bot*(f_h_h))+u_1;   // [124]
                                                                // [124]
                #undef  f_w_h                                   // [124]
                #undef  f_h_h                                   // [124]
                                                                // [---]
...
//:FUNC_RESIZE_CANVAS:[032]+[035]:===========================://
    ...
    const F_RES_CAN = function PRIVATE_F_RES_CAN( ){            // [032]
        ...
        if( d_camerah_use >= 1 ){                               // [120]
                             //:-------------------://          // [120]
            F_CAMERAH_VP1(); //: CAMERAH ==> d_vp1 ://          // [120]
        };;                  //:-------------------://          // [120]
                                                                // [---]
        if( HAS( a_g.wgl ) ){                                   // [080]
